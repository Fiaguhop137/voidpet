...
public class c {
    ...
    private File a() {
        if (this.f17711a == null) {
            synchronized (this) {
                try {
                    if (this.f17711a == null) {
                        this.f17711a = new File(this.f17712b.l().getFilesDir(), "PersistedInstallation." + this.f17712b.r() + ".json");
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    public d b(d dVar) {
        try {
            ...
            File fileCreateTempFile = File.createTempFile("PersistedInstallation", "tmp", this.f17712b.l().getFilesDir());
