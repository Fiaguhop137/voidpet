...
public abstract class c {
    ...
    /* JADX INFO: renamed from: U4.c$c, reason: collision with other inner class name */
    public static class C0186c extends FileNotFoundException {
    ...
    public static void b(File file, File file2) throws d {
        ...
        if (file2.exists()) {
            ...
            bVar = !file.exists() ? new FileNotFoundException(file.getAbsolutePath()) : null;
        } else {
            bVar = new C0186c(file.getAbsolutePath());
        }
