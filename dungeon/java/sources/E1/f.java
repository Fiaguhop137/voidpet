...
public final class f {
    ...
    private static class a extends b {
        ...
        a(TextView textView) {
            ...
            this.f2630b = new d(textView);
        }

        private InputFilter[] f(InputFilter[] inputFilterArr) {
            int length = inputFilterArr.length;
            for (InputFilter inputFilter : inputFilterArr) {
                if (inputFilter == this.f2630b) {
                    return inputFilterArr;
                }
            }
            InputFilter[] inputFilterArr2 = new InputFilter[inputFilterArr.length + 1];
            System.arraycopy(inputFilterArr, 0, inputFilterArr2, 0, length);
            inputFilterArr2[length] = this.f2630b;
        ...
        private void k() {
            this.f2629a.setFilters(a(this.f2629a.getFilters()));
        }
        ...
        InputFilter[] a(InputFilter[] inputFilterArr) {
            return !this.f2631c ? h(inputFilterArr) : f(inputFilterArr);
        }
        ...
        TransformationMethod e(TransformationMethod transformationMethod) {
            return this.f2631c ? m(transformationMethod) : j(transformationMethod);
        }
        ...
        void l() {
            this.f2629a.setTransformationMethod(e(this.f2629a.getTransformationMethod()));
        }
    }
    ...
    private static class c extends b {
        ...
        @Override // E1.f.b
        InputFilter[] a(InputFilter[] inputFilterArr) {
            return f() ? inputFilterArr : this.f2632a.a(inputFilterArr);
        }
        ...
        @Override // E1.f.b
        TransformationMethod e(TransformationMethod transformationMethod) {
            return f() ? transformationMethod : this.f2632a.e(transformationMethod);
        }
    }

    public f(TextView textView, boolean z10) {
        p199l1.g.h(textView, "textView cannot be null");
        if (z10) {
            this.f2628a = new a(textView);
        } else {
            this.f2628a = new c(textView);
        }
    }

    public InputFilter[] a(InputFilter[] inputFilterArr) {
        return this.f2628a.a(inputFilterArr);
    }
    ...
    public TransformationMethod e(TransformationMethod transformationMethod) {
        return this.f2628a.e(transformationMethod);
    }
}
