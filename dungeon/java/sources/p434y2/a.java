...
public final class a implements InterfaceC4253p {
    ...
    private final F f57774a = new F(4);

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final L f57775b = new L(-1, -1, "image/avif");

    private boolean c(InterfaceC4254q interfaceC4254q, int i10) {
        this.f57774a.W(4);
        interfaceC4254q.o(this.f57774a.f(), 0, 4);
        return this.f57774a.N() == ((long) i10);
    }

    @Override // p380v2.InterfaceC4253p
    public void a(long j10, long j11) {
        this.f57775b.a(j10, j11);
    }
    ...
    public boolean f(InterfaceC4254q interfaceC4254q) {
        interfaceC4254q.i(4);
        return c(interfaceC4254q, 1718909296) && c(interfaceC4254q, 1635150182);
    }

    @Override // p380v2.InterfaceC4253p
    public int j(InterfaceC4254q interfaceC4254q, I i10) {
        return this.f57775b.j(interfaceC4254q, i10);
    }
