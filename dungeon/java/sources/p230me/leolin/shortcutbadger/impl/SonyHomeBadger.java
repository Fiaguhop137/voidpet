...
public class SonyHomeBadger implements p285pf.a {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final Uri f49289a = Uri.parse("content://com.sonymobile.home.resourceprovider/badge");

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private AsyncQueryHandler f49290b;
    ...
    private void e(Context context, ComponentName componentName, int i10) {
        ...
        if (this.f49290b == null) {
            this.f49290b = new a(context.getApplicationContext().getContentResolver());
        }
        f(contentValuesC);
    }

    private void f(ContentValues contentValues) {
        this.f49290b.startInsert(0, null, this.f49289a, contentValues);
    }

    private void g(Context context, ContentValues contentValues) {
        context.getApplicationContext().getContentResolver().insert(this.f49289a, contentValues);
    }
