...
public final class k implements ImageHeaderParser {
    ...
    static final byte[] f57893a = "Exif\u0000\u0000".getBytes(Charset.forName("UTF-8"));

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final int[] f57894b = {0, 1, 1, 2, 4, 8, 1, 1, 2, 4, 8, 4, 8};

    private static final class a implements c {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final ByteBuffer f57895a;

        a(ByteBuffer byteBuffer) {
            this.f57895a = byteBuffer;
        ...
        public int b(byte[] bArr, int i10) {
            int iMin = Math.min(i10, this.f57895a.remaining());
            if (iMin == 0) {
                return -1;
            }
            this.f57895a.get(bArr, 0, iMin);
            return iMin;
        }

        @Override // y4.k.c
        public short c() throws c.a {
            if (this.f57895a.remaining() >= 1) {
                return (short) (this.f57895a.get() & 255);
            }
            throw new c.a();
        }
        ...
        public long skip(long j10) {
            int iMin = (int) Math.min(this.f57895a.remaining(), j10);
            ByteBuffer byteBuffer = this.f57895a;
    ...
    private static final class b {
        ...
        b(byte[] bArr, int i10) {
            this.f57896a = (ByteBuffer) ByteBuffer.wrap(bArr).order(ByteOrder.BIG_ENDIAN).limit(i10);
        }

        private boolean c(int i10, int i11) {
            return this.f57896a.remaining() - i10 >= i11;
        }

        short a(int i10) {
            if (c(i10, 2)) {
                return this.f57896a.getShort(i10);
            }
            return (short) -1;
        }
        ...
        int b(int i10) {
            if (c(i10, 4)) {
                return this.f57896a.getInt(i10);
            }
            return -1;
        }

        int d() {
            return this.f57896a.remaining();
        }

        void e(ByteOrder byteOrder) {
            this.f57896a.order(byteOrder);
        }
    }
    ...
    private static final class d implements c {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final InputStream f57897a;

        d(InputStream inputStream) {
            this.f57897a = inputStream;
        }
        ...
        public int b(byte[] bArr, int i10) throws c.a {
            int i11 = 0;
            int i12 = 0;
            while (i11 < i10 && (i12 = this.f57897a.read(bArr, i11, i10 - i11)) != -1) {
                i11 += i12;
            }
            if (i11 == 0 && i12 == -1) {
                throw new c.a();
        ...
        public long skip(long j10) throws IOException {
            ...
            long j11 = j10;
            while (j11 > 0) {
                long jSkip = this.f57897a.skip(j11);
                if (jSkip <= 0) {
                    if (this.f57897a.read() == -1) {
                        break;
                    }
                    jSkip = 1;
                }
    ...
    private int f(c cVar, p328s4.b bVar) {
        try {
            int iA = cVar.a();
            if (!h(iA)) {
    ...
    private boolean i(byte[] bArr, int i10) {
        boolean z10 = bArr != null && i10 > f57893a.length;
        if (z10) {
            int i11 = 0;
            while (true) {
                byte[] bArr2 = f57893a;
    ...
    public int a(ByteBuffer byteBuffer, p328s4.b bVar) {
        return f(new a((ByteBuffer) L4.k.d(byteBuffer)), (p328s4.b) L4.k.d(bVar));
    }

    @Override // com.bumptech.glide.load.ImageHeaderParser
    public int b(InputStream inputStream, p328s4.b bVar) {
        return f(new d((InputStream) L4.k.d(inputStream)), (p328s4.b) L4.k.d(bVar));
    }

    @Override // com.bumptech.glide.load.ImageHeaderParser
    public ImageHeaderParser.ImageType c(ByteBuffer byteBuffer) {
        return g(new a((ByteBuffer) L4.k.d(byteBuffer)));
    }

    @Override // com.bumptech.glide.load.ImageHeaderParser
    public ImageHeaderParser.ImageType d(InputStream inputStream) {
        return g(new d((InputStream) L4.k.d(inputStream)));
    }
}
