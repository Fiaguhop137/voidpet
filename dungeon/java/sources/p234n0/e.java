...
public abstract class e {
    ...
    private static boolean f49460a = true;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static boolean f49461b;

    public static final void c(d dVar, z zVar) {
        d(dVar, zVar, p019b0.e.f25805b.c());
    }

    public static final void d(d dVar, z zVar, long j10) {
        if (f49460a) {
            f(dVar, zVar, j10);
        } else {
            e(dVar, zVar, j10);
    ...
    private static final void e(d dVar, z zVar, long j10) {
        ...
        int i10 = 0;
        while (i10 < size) {
            C3981d c3981d = (C3981d) listE.get(i10);
            long jP = p019b0.e.p(c3981d.b(), jK);
            long jB = c3981d.b();
            dVar.f(p019b0.e.q(dVar.c(), jP));
            dVar.a(c3981d.c(), p019b0.e.q(dVar.c(), j10));
            i10++;
            jK = jB;
        }
        dVar.f(p019b0.e.q(dVar.c(), p019b0.e.p(zVar.h(), jK)));
        dVar.a(zVar.n(), p019b0.e.q(dVar.c(), j10));
    }

    private static final void f(d dVar, z zVar, long j10) {
        if (AbstractC3994q.b(zVar)) {
            dVar.e();
        }
        if (!AbstractC3994q.d(zVar)) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                C3981d c3981d = (C3981d) listE.get(i10);
                dVar.a(c3981d.c(), p019b0.e.q(c3981d.a(), j10));
            }
            dVar.a(zVar.n(), p019b0.e.q(zVar.g(), j10));
        }
        if (AbstractC3994q.d(zVar) && zVar.n() - dVar.d() > 40) {
            dVar.e();
        }
        dVar.g(zVar.n());
    }
    ...
    public static final float[] j(float[] fArr, float[] fArr2, int i10, int i11, float[] fArr3) {
        ...
        while (i19 < i13) {
            ...
            AbstractC3952n.i(fArr4[i19], fArr7, 0, 0, i10);
