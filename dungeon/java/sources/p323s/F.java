...
public final class F extends AbstractC4114n {
    ...
    private final int i(int i10) {
        ...
        while (true) {
            ...
            if ((((~j10) << 6) & j10 & (-9187201950435737472L)) != 0) {
                int iJ = j(i12);
                if (this.f52603f == 0 && ((this.f52738a[iJ >> 3] >> ((iJ & 7) << 3)) & 255) != 254) {
                    f();
                    iJ = j(i12);
                }
                this.f52742e++;
                int i23 = this.f52603f;
                long[] jArr2 = this.f52738a;
                int i24 = iJ >> 3;
                long j14 = jArr2[i24];
                int i25 = (iJ & 7) << 3;
                this.f52603f = i23 - (((j14 >> i25) & 255) == 128 ? i22 : 0);
                int i26 = this.f52741d;
                long j15 = ((~(255 << i25)) & j14) | (j11 << i25);
                jArr2[i24] = j15;
                jArr2[(((iJ - 7) & i26) + (i26 & 7)) >> 3] = j15;
                return iJ;
            }
            i16 = i20 + 8;
            i15 = (i15 + i16) & i14;
    ...
    private final void k() {
        this.f52603f = a0.a(c()) - this.f52742e;
    }
    ...
    private final void m(int i10) {
        ...
        this.f52741d = iMax;
        l(iMax);
        this.f52739b = new int[iMax];
        this.f52740c = new Object[iMax];
    }

    public final void f() {
        if (this.f52741d <= 8 || Long.compare(z.g(z.g(this.f52742e) * 32) ^ Long.MIN_VALUE, z.g(z.g(this.f52741d) * 25) ^ Long.MIN_VALUE) > 0) {
            p(a0.c(this.f52741d));
        } else {
            h();
        }
    ...
    public final void g() {
        ...
        if (jArr != a0.f52677a) {
            ...
            long[] jArr2 = this.f52738a;
            int i10 = this.f52741d;
            int i11 = i10 >> 3;
            long j10 = 255 << ((i10 & 7) << 3);
            jArr2[i11] = (jArr2[i11] & (~j10)) | j10;
        }
        AbstractC3952n.v(this.f52740c, null, 0, this.f52741d);
        k();
    }
    ...
    public final void p(int i10) {
        ...
        int[] iArr = f10.f52739b;
        Object[] objArr = f10.f52740c;
        int i11 = f10.f52741d;
        m(i10);
        long[] jArr2 = f10.f52738a;
        int[] iArr2 = f10.f52739b;
        Object[] objArr2 = f10.f52740c;
        int i12 = f10.f52741d;
        int i13 = 0;
        while (i13 < i11) {
    ...
    public final void q(int i10, Object obj) {
        int i11 = i(i10);
        this.f52739b[i11] = i10;
        this.f52740c[i11] = obj;
    }
}
