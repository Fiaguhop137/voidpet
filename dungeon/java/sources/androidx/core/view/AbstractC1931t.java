...
public abstract class AbstractC1931t {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private static boolean f23269a = false;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static Method f23270b = null;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static boolean f23271c = false;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static Field f23272d;
    ...
    private static boolean a(ActionBar actionBar, KeyEvent keyEvent) {
        if (!f23269a) {
            try {
                f23270b = actionBar.getClass().getMethod("onMenuKeyEvent", KeyEvent.class);
            } catch (NoSuchMethodException unused) {
            }
            f23269a = true;
        }
        Method method = f23270b;
        if (method != null) {
            try {
    ...
    public static boolean e(a aVar, View view, Window.Callback callback, KeyEvent keyEvent) {
        ...
        return (view != null && Z.h(view, keyEvent)) || aVar.j(keyEvent);
    }
