...
public abstract class b {
    ...
    private static final ThreadLocal f23075a = new ThreadLocal();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f23076b = new ThreadLocal();
    ...
    static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f23075a;
        ...
        ThreadLocal threadLocal2 = f23076b;
