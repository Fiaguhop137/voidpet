...
public abstract class a {
    ...
    protected final C4101a f25775a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    protected final C4101a f25776b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    protected final C4101a f25777c;

    public a(C4101a c4101a, C4101a c4101a2, C4101a c4101a3) {
        this.f25775a = c4101a;
        this.f25776b = c4101a2;
        this.f25777c = c4101a3;
    }

    private void N(p399w3.a aVar) {
        try {
    ...
    private Class c(Class cls) throws ClassNotFoundException {
        Class cls2 = (Class) this.f25777c.get(cls.getName());
        if (cls2 != null) {
            return cls2;
        }
        Class<?> cls3 = Class.forName(String.format("%s.%sParcelizer", cls.getPackage().getName(), cls.getSimpleName()), false, cls.getClassLoader());
        this.f25777c.put(cls.getName(), cls3);
        return cls3;
    }

    private Method d(String str) throws NoSuchMethodException {
        Method method = (Method) this.f25775a.get(str);
        if (method != null) {
            return method;
        }
        System.currentTimeMillis();
        Method declaredMethod = Class.forName(str, true, a.class.getClassLoader()).getDeclaredMethod("read", a.class);
        this.f25775a.put(str, declaredMethod);
        return declaredMethod;
    }

    private Method e(Class cls) throws NoSuchMethodException, ClassNotFoundException {
        Method method = (Method) this.f25776b.get(cls.getName());
        if (method != null) {
            return method;
        }
        Class clsC = c(cls);
        ...
        this.f25776b.put(cls.getName(), declaredMethod);
        return declaredMethod;
    }
    ...
    protected void K(p399w3.a aVar, a aVar2) {
        try {
    ...
    protected void L(p399w3.a aVar) {
        if (aVar == null) {
            I(null);
            return;
        }
    ...
    public void M(p399w3.a aVar, int i10) {
        w(i10);
        L(aVar);
    }
    ...
    protected p399w3.a n(String str, a aVar) {
        try {
            return (p399w3.a) d(str).invoke(null, aVar);
        } catch (ClassNotFoundException e10) {
            throw new RuntimeException("VersionedParcel encountered ClassNotFoundException", e10);
        } catch (IllegalAccessException e11) {
            throw new RuntimeException("VersionedParcel encountered IllegalAccessException", e11);
    ...
    public p399w3.a v(p399w3.a aVar, int i10) {
        return !m(i10) ? aVar : u();
    }
