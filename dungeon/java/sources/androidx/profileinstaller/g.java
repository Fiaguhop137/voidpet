...
abstract class g {
    ...
    static final byte[] f24856a = {112, 114, 111, 0};

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    static final byte[] f24857b = {112, 114, 109, 0};

    private static void A(byte[] bArr, int i10, int i11, c cVar) {
        int iM = m(i10, i11, cVar.f24844g);
        int i12 = iM / 8;
    ...
    static boolean C(OutputStream outputStream, byte[] bArr, c[] cVarArr) throws IOException {
        if (Arrays.equals(bArr, i.f24869a)) {
            P(outputStream, cVarArr);
            return true;
        }
        if (Arrays.equals(bArr, i.f24870b)) {
            O(outputStream, cVarArr);
            return true;
        }
        if (Arrays.equals(bArr, i.f24872d)) {
            M(outputStream, cVarArr);
            return true;
        }
        if (Arrays.equals(bArr, i.f24871c)) {
            N(outputStream, cVarArr);
            return true;
        }
        if (!Arrays.equals(bArr, i.f24873e)) {
            return false;
        }
    ...
    private static j E(c[] cVarArr) throws IOException {
        ...
        try {
            ...
            int i10 = 2;
            for (c cVar : cVarArr) {
                d.q(byteArrayOutputStream, cVar.f24840c);
                d.q(byteArrayOutputStream, cVar.f24841d);
                d.q(byteArrayOutputStream, cVar.f24844g);
                String strJ = j(cVar.f24838a, cVar.f24839b, i.f24869a);
                int iK = d.k(strJ);
    ...
    private static void H(OutputStream outputStream, c cVar, String str) throws IOException {
        ...
        d.p(outputStream, cVar.f24842e);
        d.q(outputStream, cVar.f24843f);
        d.q(outputStream, cVar.f24840c);
        d.q(outputStream, cVar.f24844g);
        d.n(outputStream, str);
    }

    private static void I(OutputStream outputStream, c cVar) throws IOException {
        byte[] bArr = new byte[k(cVar.f24844g)];
        for (Map.Entry entry : cVar.f24846i.entrySet()) {
    ...
    private static void J(OutputStream outputStream, int i10, c cVar) throws IOException {
        byte[] bArr = new byte[l(i10, cVar.f24844g)];
        for (Map.Entry entry : cVar.f24846i.entrySet()) {
            int iIntValue = ((Integer) entry.getKey()).intValue();
            int iIntValue2 = ((Integer) entry.getValue()).intValue();
            int i11 = 0;
            for (int i12 = 1; i12 <= 4; i12 <<= 1) {
                if (i12 != 1 && (i12 & i10) != 0) {
                    if ((i12 & iIntValue2) == i12) {
                        int i13 = (cVar.f24844g * i11) + iIntValue;
                        int i14 = i13 / 8;
    ...
    private static void L(OutputStream outputStream, c[] cVarArr) throws IOException {
        ...
        for (c cVar : cVarArr) {
            String strJ = j(cVar.f24838a, cVar.f24839b, i.f24873e);
            d.p(outputStream, d.k(strJ));
            d.p(outputStream, cVar.f24846i.size());
            d.p(outputStream, cVar.f24845h.length);
            d.q(outputStream, cVar.f24840c);
            d.n(outputStream, strJ);
            Iterator it = cVar.f24846i.keySet().iterator();
            while (it.hasNext()) {
                d.p(outputStream, ((Integer) it.next()).intValue());
            }
            for (int i10 : cVar.f24845h) {
    ...
    private static void M(OutputStream outputStream, c[] cVarArr) throws IOException {
        ...
        for (c cVar : cVarArr) {
            int size = cVar.f24846i.size() * 4;
            String strJ = j(cVar.f24838a, cVar.f24839b, i.f24872d);
            d.p(outputStream, d.k(strJ));
            d.p(outputStream, cVar.f24845h.length);
    ...
    private static void Q(OutputStream outputStream, c[] cVarArr) throws IOException {
        ...
        long length2 = ((long) i.f24869a.length) + ((long) f24856a.length) + 4 + ((long) (arrayList.size() * 16));
        d.q(outputStream, arrayList.size());
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            j jVar = (j) arrayList.get(i10);
            d.q(outputStream, jVar.f24876a.g());
            d.q(outputStream, length2);
            if (jVar.f24879d) {
                byte[] bArr = jVar.f24878c;
                ...
                arrayList2.add(jVar.f24878c);
                d.q(outputStream, jVar.f24878c.length);
                d.q(outputStream, 0L);
                length = jVar.f24878c.length;
            }
            length2 += (long) length;
        }
    ...
    private static int a(c cVar) {
        Iterator it = cVar.f24846i.entrySet().iterator();
        int iIntValue = 0;
        while (it.hasNext()) {
    ...
    private static byte[] b(c[] cVarArr, byte[] bArr) throws IOException {
        ...
        int iK = 0;
        for (c cVar : cVarArr) {
            iK += d.k(j(cVar.f24838a, cVar.f24839b, bArr)) + 16 + (cVar.f24842e * 2) + cVar.f24843f + k(cVar.f24844g);
        }
        ...
        if (Arrays.equals(bArr, i.f24871c)) {
            ...
            while (i10 < length) {
                c cVar2 = cVarArr[i10];
                H(byteArrayOutputStream, cVar2, j(cVar2.f24838a, cVar2.f24839b, bArr));
                G(byteArrayOutputStream, cVar2);
                i10++;
            }
        } else {
            for (c cVar3 : cVarArr) {
                H(byteArrayOutputStream, cVar3, j(cVar3.f24838a, cVar3.f24839b, bArr));
            }
    ...
    private static j c(c[] cVarArr) throws IOException {
        ...
        for (int i11 = 0; i11 < cVarArr.length; i11++) {
            try {
                ...
                d.p(byteArrayOutputStream, cVar.f24842e);
                i10 = i10 + 4 + (cVar.f24842e * 2);
    ...
    private static c i(c[] cVarArr, String str) {
        ...
        for (int i10 = 0; i10 < cVarArr.length; i10++) {
            if (cVarArr[i10].f24839b.equals(strH)) {
                return cVarArr[i10];
            }
        }
        return null;
    ...
    static byte[] p(InputStream inputStream, byte[] bArr) {
        if (Arrays.equals(bArr, d.d(inputStream, bArr.length))) {
            return d.d(inputStream, i.f24870b.length);
        }
        throw d.c("Invalid magic");
    }

    private static void q(InputStream inputStream, c cVar) {
        int iAvailable = inputStream.available() - cVar.f24843f;
        int iH = 0;
        while (inputStream.available() > iAvailable) {
            iH += d.h(inputStream);
            cVar.f24846i.put(Integer.valueOf(iH), 1);
    ...
    static c[] r(InputStream inputStream, byte[] bArr, byte[] bArr2, c[] cVarArr) {
        if (Arrays.equals(bArr, i.f24874f)) {
            if (Arrays.equals(i.f24869a, bArr2)) {
        ...
        if (Arrays.equals(bArr, i.f24875g)) {
    ...
    private static c[] t(InputStream inputStream, int i10, c[] cVarArr) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            c cVar = cVarArr[i12];
            if (!cVar.f24839b.equals(strArr[i12])) {
                throw d.c("Order of dexfiles in metadata did not match baseline");
            }
            int i13 = iArr[i12];
            cVar.f24842e = i13;
            cVar.f24845h = n(inputStream, i13);
        }
        return cVarArr;
    }
    ...
    private static void w(InputStream inputStream, c cVar) {
        BitSet bitSetValueOf = BitSet.valueOf(d.d(inputStream, d.a(cVar.f24844g * 2)));
        int i10 = 0;
        while (true) {
            int i11 = cVar.f24844g;
            if (i10 >= i11) {
                return;
            }
            int iO = o(bitSetValueOf, i10, i11);
            if (iO != 0) {
                Integer num = (Integer) cVar.f24846i.get(Integer.valueOf(i10));
                if (num == null) {
                    num = 0;
                }
                cVar.f24846i.put(Integer.valueOf(i10), Integer.valueOf(iO | num.intValue()));
            }
            i10++;
        }
    }
    ...
    private static c[] y(InputStream inputStream, String str, int i10) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            c cVar = cVarArr[i12];
            q(inputStream, cVar);
            cVar.f24845h = n(inputStream, cVar.f24842e);
            w(inputStream, cVar);
        }
        return cVarArr;
    }
