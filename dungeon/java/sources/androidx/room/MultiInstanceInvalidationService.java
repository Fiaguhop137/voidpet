...
public final class MultiInstanceInvalidationService extends Service {
    ...
    public static final class a extends androidx.room.b.a {
        ...
        public void Y0(androidx.room.a callback, int i10) {
        ...
        @Override // androidx.room.b
        public void a0(int i10, String[] tables) {
                ...
                try {
                    ...
                    for (int i11 = 0; i11 < iBeginBroadcast; i11++) {
                        try {
                            ...
                            if (i10 != iIntValue && Intrinsics.b(str, str2)) {
                                try {
                                    ((androidx.room.a) multiInstanceInvalidationService.getCallbackList().getBroadcastItem(i11)).s(tables);
        ...
        @Override // androidx.room.b
        public int v0(androidx.room.a callback, String str) {
            Intrinsics.checkNotNullParameter(callback, "callback");
            int i10 = 0;
            if (str == null) {
                return 0;
