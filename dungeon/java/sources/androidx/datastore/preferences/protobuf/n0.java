...
interface n0 {
    ...
    void J(int i10, List list, a0 a0Var);

    void K(int i10, AbstractC1950f abstractC1950f);

    void L(int i10, Object obj, a0 a0Var);

    void M(int i10, D.a aVar, Map map);

    void N(int i10, Object obj, a0 a0Var);

    void O(int i10, List list, a0 a0Var);
