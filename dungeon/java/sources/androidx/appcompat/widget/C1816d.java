...
public class C1816d extends AutoCompleteTextView {

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final int[] f20969d = {16843126};

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final C1817e f20970a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final C f20971b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final C1825m f20972c;

    public C1816d(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, p144i.a.f43085m);
    }

    public C1816d(Context context, AttributeSet attributeSet, int i10) {
        super(e0.b(context), attributeSet, i10);
        d0.a(this, getContext());
        h0 h0VarV = h0.v(getContext(), attributeSet, f20969d, i10, 0);
        if (h0VarV.s(0)) {
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f20971b.j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f20971b.k();
    }

    @Override // android.widget.TextView, android.view.View
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f20972c.d(AbstractC1827o.a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f20972c.a(keyListener));
    }
