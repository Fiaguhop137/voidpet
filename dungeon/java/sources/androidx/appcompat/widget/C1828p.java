...
public class C1828p extends ImageButton {
    ...
    private final C1817e f21071a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final C1829q f21072b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private boolean f21073c;

    public C1828p(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, p144i.a.f43060A);
    }

    public C1828p(Context context, AttributeSet attributeSet, int i10) {
    ...
    protected void drawableStateChanged() {
        ...
        C1817e c1817e = this.f21071a;
        if (c1817e != null) {
            c1817e.b();
        }
        C1829q c1829q = this.f21072b;
        if (c1829q != null) {
            c1829q.c();
        }
    }
    ...
    public boolean hasOverlappingRendering() {
        return this.f21072b.f() && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        C1829q c1829q = this.f21072b;
        if (c1829q != null && drawable != null && !this.f21073c) {
            c1829q.h(drawable);
        }
        super.setImageDrawable(drawable);
        C1829q c1829q2 = this.f21072b;
        if (c1829q2 != null) {
            c1829q2.c();
            if (this.f21073c) {
                return;
