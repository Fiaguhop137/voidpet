...
class C1832u {
    ...
    private static final int[] f21112c = {16843067, 16843068};

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final ProgressBar f21113a;
    ...
    C1832u(ProgressBar progressBar) {
        this.f21113a = progressBar;
    }
    ...
    void c(AttributeSet attributeSet, int i10) {
        h0 h0VarV = h0.v(this.f21113a.getContext(), attributeSet, f21112c, i10, 0);
        Drawable drawableH = h0VarV.h(0);
        if (drawableH != null) {
            this.f21113a.setIndeterminateDrawable(e(drawableH));
        }
        Drawable drawableH2 = h0VarV.h(1);
        if (drawableH2 != null) {
            this.f21113a.setProgressDrawable(d(drawableH2, false));
        }
        h0VarV.x();
    }
    ...
    Drawable d(Drawable drawable, boolean z10) {
        if (drawable instanceof p038c1.c) {
            p038c1.c cVar = (p038c1.c) drawable;
