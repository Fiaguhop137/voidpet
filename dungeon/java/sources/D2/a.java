...
public final class a implements InterfaceC4253p {
    ...
    private final InterfaceC4253p f2112a;

    public a(int i10) {
        if ((i10 & 1) != 0) {
            this.f2112a = new L(65496, 2, "image/jpeg");
        } else {
            this.f2112a = new b();
        }
    }
    ...
    public boolean f(InterfaceC4254q interfaceC4254q) {
        return this.f2112a.f(interfaceC4254q);
    }

    @Override // p380v2.InterfaceC4253p
    public int j(InterfaceC4254q interfaceC4254q, I i10) {
        return this.f2112a.j(interfaceC4254q, i10);
    }
