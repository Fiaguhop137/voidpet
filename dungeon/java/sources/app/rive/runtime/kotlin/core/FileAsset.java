...
public abstract class FileAsset extends NativeObject {
    ...
    private FileAsset(long j10, int i10) {
        super(j10);
        this.rendererType = RendererType.INSTANCE.fromIndex(i10);
        this.name = j.b(new FileAsset$name$2(this));
        this.uniqueFilename = j.b(new FileAsset$uniqueFilename$2(this));
        this.cdnUrl = j.b(new FileAsset$cdnUrl$2(this));
    }
