...
public interface CoroutineContext {
    ...
    public interface Element extends CoroutineContext {
        ...
        public static final class a {
            ...
            public static CoroutineContext c(Element element, b key) {
                Intrinsics.checkNotNullParameter(key, "key");
                return Intrinsics.b(element.getKey(), key) ? e.f48283a : element;
            }
    ...
    public static final class a {
        public static CoroutineContext b(CoroutineContext coroutineContext, CoroutineContext context) {
            Intrinsics.checkNotNullParameter(context, "context");
            return context == e.f48283a ? coroutineContext : (CoroutineContext) context.b0(coroutineContext, new Ed.d());
        }
        ...
        public static CoroutineContext c(CoroutineContext acc, Element element) {
            ...
            CoroutineContext coroutineContextS = acc.S(element.getKey());
            e eVar = e.f48283a;
            if (coroutineContextS == eVar) {
                return element;
            }
            d.b bVar = d.f48281C1;
            d dVar = (d) coroutineContextS.e(bVar);
            if (dVar == null) {
                return new c(coroutineContextS, element);
            }
            CoroutineContext coroutineContextS2 = coroutineContextS.S(bVar);
            return coroutineContextS2 == eVar ? new c(element, dVar) : new c(new c(coroutineContextS2, element), dVar);
        }
    }
    ...
    CoroutineContext P(CoroutineContext context);

    CoroutineContext S(b key);

    Object b0(Object initial, Function2 operation);
