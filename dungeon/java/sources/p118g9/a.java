...
public abstract class a {
    public static int a(int i10, int i11) {
        return AbstractC2044c.k(i10, (Color.alpha(i10) * i11) / 255);
    }
    ...
    public static boolean h(int i10) {
        return i10 != 0 && AbstractC2044c.d(i10) > 0.5d;
    }

    public static int i(int i10, int i11) {
        return AbstractC2044c.g(i11, i10);
    }

    public static int j(int i10, int i11, float f10) {
        return i(i10, AbstractC2044c.k(i11, Math.round(Color.alpha(i11) * f10)));
    }
    ...
    private static int l(Context context, TypedValue typedValue) {
        ...
        return i10 != 0 ? Z0.b.c(context, i10) : typedValue.data;
    }
}
