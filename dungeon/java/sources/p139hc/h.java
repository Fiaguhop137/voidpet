...
public final class h implements j, e, i {
    ...
    public byte e(int i10) {
        return this.f42811a.readByte(i10);
    }

    @Override // p139hc.j
    public int getLength() {
        return this.f42811a.getLength();
    }
    ...
    public ByteBuffer toDirectBuffer() {
        return this.f42811a.toDirectBuffer();
    }
}
