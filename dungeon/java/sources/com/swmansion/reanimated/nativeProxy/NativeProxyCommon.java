...
public abstract class NativeProxyCommon {
    private final Ga.a gestureHandlerStateManager;
    ...
    protected NativeProxyCommon(ReactApplicationContext reactApplicationContext) {
        ...
        try {
            ...
            aVar = (Ga.a) reactApplicationContext.getNativeModule(RNGestureHandlerModule.class);
    ...
    public void setGestureState(int i10, int i11) {
        Ga.a aVar = this.gestureHandlerStateManager;
        if (aVar != null) {
