...
public class SharedTransitionManager {
    ...
    class TopWillAppearListener implements i {
    ...
    private List<SharedElement> getSharedElementsForCurrentTransition(List<View> list, boolean z10) {
        ...
        for (View view : list) {
            ...
            boolean z13 = !z10 && hashSet.contains(Integer.valueOf(iFindPrecedingViewTagForTransition));
                    ...
                    if (zContainsKey) {
                        ...
                        if (viewFindScreen != null && viewFindScreen2 != null && (viewGroup = (ViewGroup) findStack(viewFindScreen)) != null) {
                            ...
                            for (int i10 = 0; i10 < viewGroupManager.getChildCount(viewGroup); i10++) {
                                if (viewGroupManager.getChildAt(viewGroup, i10) == viewFindScreen2) {
                                    z14 = true;
                                }
                            }
                            if (z14) {
                                ...
                                if (childCount >= 2) {
                                    ...
                                    if (!z10 ? !(childAt.getId() != viewFindScreen.getId() || childAt2.getId() != viewFindScreen2.getId()) : !(childAt2.getId() != viewFindScreen.getId() || childAt.getId() != viewFindScreen2.getId())) {
                                    }
                                }
                            }
                            z12 = z11;
    ...
    private View maybeOverrideSiblingForTabNavigator(View view, View view2) {
        ...
        while (i10 >= 0) {
            View viewResolveView = this.mAnimationsManager.resolveView(sharedGroup[i10]);
    ...
    private void setupTransitionContainer() {
        ...
        if (this.mTransitionContainer == null) {
            this.mTransitionContainer = new g(this.mAnimationsManager.getContext());
        }
    ...
    private void startSharedAnimationForView(View view, Snapshot snapshot, Snapshot snapshot2, int i10) {
        ...
        this.mNativeMethodsHolder.startAnimation(view.getId(), i10, map);
    }
            ...
            if (snapshot != null) {
                ...
                for (String str : basicMap.keySet()) {
                    ...
                    if (str.equals("transformMatrix")) {
                        ...
                        map.put(str, Double.valueOf(H.g(Utils.convertToFloat(obj))));
                    }
                }
    ...
    protected void screenDidLayout(View view) {
        ...
        if (this.mAddedSharedViews.isEmpty() || (eventDispatcherC = C2270o0.c((ReactContext) view.getContext(), view.getId())) == null) {
            return;
        }
        eventDispatcherC.c(new TopWillAppearListener(eventDispatcherC));
    }
