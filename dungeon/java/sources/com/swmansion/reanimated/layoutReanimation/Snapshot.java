...
public class Snapshot {
    ...
    public int width;
    public static ArrayList<String> targetKeysToTransform = new ArrayList<>(Arrays.asList("targetWidth", "targetHeight", "targetOriginX", "targetOriginY", "targetGlobalOriginX", "targetGlobalOriginY", "targetBorderRadius", "targetBorderTopLeftRadius", "targetBorderTopRightRadius", "targetBorderBottomLeftRadius", "targetBorderBottomRightRadius"));
    public static ArrayList<String> currentKeysToTransform = new ArrayList<>(Arrays.asList("currentWidth", "currentHeight", "currentOriginX", "currentOriginY", "currentGlobalOriginX", "currentGlobalOriginY", "currentBorderRadius", "currentBorderTopLeftRadius", "currentBorderTopRightRadius", "currentBorderBottomLeftRadius", "currentBorderBottomRightRadius"));
    ...
    public Snapshot(View view) {
        ...
        if (viewFindTransformedView != null) {
            ...
            int i11 = this.width;
            this.originX = (int) (f10 - ((i11 - (i11 * viewFindTransformedView.getScaleX())) / 2.0f));
            float f11 = this.originY;
            int i12 = this.height;
            this.originY = (int) (f11 - ((i12 - (i12 * viewFindTransformedView.getScaleY())) / 2.0f));
        }
    ...
    Snapshot(View view, D d10) {
        ...
        try {
            this.viewManager = d10.resolveViewManager(view.getId());
            this.parentViewManager = d10.resolveViewManager(this.parent.getId());
        } catch (C2275s | NullPointerException unused) {
        }
        this.width = view.getWidth();
        this.height = view.getHeight();
    ...
    private void addBasicConfig(HashMap<String, Object> map) {
        map.put("originY", Integer.valueOf(this.originY));
        map.put("originX", Integer.valueOf(this.originX));
        map.put("globalOriginY", Integer.valueOf(this.globalOriginY));
        map.put("globalOriginX", Integer.valueOf(this.globalOriginX));
        map.put("height", Integer.valueOf(this.height));
        map.put("width", Integer.valueOf(this.width));
        map.put("transformMatrix", this.transformMatrix);
    ...
    private void addCurrentConfig(HashMap<String, Object> map) {
        map.put("currentOriginY", Integer.valueOf(this.originY));
        map.put("currentOriginX", Integer.valueOf(this.originX));
        map.put("currentGlobalOriginY", Integer.valueOf(this.globalOriginY));
        map.put("currentGlobalOriginX", Integer.valueOf(this.globalOriginX));
        map.put("currentHeight", Integer.valueOf(this.height));
        map.put("currentWidth", Integer.valueOf(this.width));
        map.put("currentTransformMatrix", this.transformMatrix);
        map.put("currentBorderRadius", Float.valueOf(this.borderRadii.full));
        map.put("currentBorderTopLeftRadius", Float.valueOf(this.borderRadii.topLeft));
        map.put("currentBorderTopRightRadius", Float.valueOf(this.borderRadii.topRight));
        map.put("currentBorderBottomLeftRadius", Float.valueOf(this.borderRadii.bottomLeft));
        map.put("currentBorderBottomRightRadius", Float.valueOf(this.borderRadii.bottomRight));
    }

    private void addTargetConfig(HashMap<String, Object> map) {
        map.put("targetOriginY", Integer.valueOf(this.originY));
        map.put("targetOriginX", Integer.valueOf(this.originX));
        map.put("targetGlobalOriginY", Integer.valueOf(this.globalOriginY));
        map.put("targetGlobalOriginX", Integer.valueOf(this.globalOriginX));
        map.put("targetHeight", Integer.valueOf(this.height));
        map.put("targetWidth", Integer.valueOf(this.width));
        map.put("targetTransformMatrix", this.transformMatrix);
        map.put("targetBorderRadius", Float.valueOf(this.borderRadii.full));
        map.put("targetBorderTopLeftRadius", Float.valueOf(this.borderRadii.topLeft));
        map.put("targetBorderTopRightRadius", Float.valueOf(this.borderRadii.topRight));
        map.put("targetBorderBottomLeftRadius", Float.valueOf(this.borderRadii.bottomLeft));
        map.put("targetBorderBottomRightRadius", Float.valueOf(this.borderRadii.bottomRight));
    }
    ...
    private View findTransformedView(View view) {
        ...
        while (true) {
            ...
            boolean z11 = !zEquals;
            if (!zEquals || view2.getClass().getSimpleName().equals("Screen")) {
                z10 = z11;
                break;
            }
            z10 = z11;
