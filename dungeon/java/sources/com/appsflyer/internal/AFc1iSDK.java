...
public final class AFc1iSDK extends HashMap<String, Object> {
    ...
    private static void a(int i10, int i11, char c10, Object[] objArr) {
        ...
        while (true) {
            ...
            jArr[i13] = (((long) ((char) (((long) getMediationNetwork[i11 + i13]) ^ (-2577524606577954075L)))) ^ (((long) i13) * ((-2577524606577954075L) ^ getCurrencyIso4217Code))) ^ ((long) c10);
    ...
    private static void b(String str, int i10, Object[] objArr) {
        ...
        while (true) {
            ...
            int i12 = ($11 + 85) % 128;
            $10 = i12;
            jArr[i11] = (((long) cArr[i11]) ^ (((long) i11) * ((long) aFk1nSDK.AFAdRevenueData))) ^ (AFAdRevenueData ^ (-4672045500807300752L));
    ...
    /* JADX WARN: Code duplicated, block: B:17:0x01c2  */
