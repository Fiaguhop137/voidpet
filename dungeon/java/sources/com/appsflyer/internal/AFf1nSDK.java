...
public final class AFf1nSDK {
    ...
    private static void a(String str, int[] iArr, String str2, int i10, Object[] objArr) throws UnsupportedEncodingException {
        ...
        int i12 = (int) (1825820251896122634L ^ ((long) getMediationNetwork));
        if (getRevenue) {
            $10 = ($11 + 3) % 128;
    ...
    @NonNull
    private static AFi1sSDK getCurrencyIso4217Code(@NonNull AFi1vSDK aFi1vSDK, String str, @NonNull String str2, @NonNull String str3) throws UnsupportedEncodingException {
        String string;
        if (str == null) {
