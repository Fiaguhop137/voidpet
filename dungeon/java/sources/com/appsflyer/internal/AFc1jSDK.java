...
public final class AFc1jSDK extends ThreadPoolExecutor implements AutoCloseable {
    ...
    private AFc1jSDK(int i10, int i11, long j10, @NotNull TimeUnit timeUnit, @NotNull BlockingQueue<Runnable> blockingQueue, @NotNull Queue<Runnable> queue) {
        super(i10, i11, j10, timeUnit, blockingQueue, new RejectedExecutionHandlerC2167o(queue));
    ...
    protected final void afterExecute(@NotNull Runnable p10, @Nullable Throwable p11) {
        Intrinsics.checkNotNullParameter(p10, "");
        super.afterExecute(p10, p11);
        Intrinsics.checkNotNullParameter(p10, "");
        if (p11 == null) {
            try {
        ...
        AFh1ySDK.e$default(AFLogger.INSTANCE, AFg1cSDK.AF_EXECUTOR, "Error while executing task: " + p10, p11, true, true, true, false, 64, null);
    }
