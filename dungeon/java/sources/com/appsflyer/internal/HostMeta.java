...
/* JADX INFO: renamed from: com.appsflyer.internal.AFe1xSDK, reason: from toString */
...
public final /* data */ class HostMeta {
    ...
    public HostMeta(@NotNull String str, @Nullable String str2, @NotNull AFe1tSDK aFe1tSDK) {
    ...
    public final boolean equals(@Nullable Object p10) {
        ...
        if (!(p10 instanceof HostMeta)) {
            return false;
        }
        HostMeta hostMeta = (HostMeta) p10;
