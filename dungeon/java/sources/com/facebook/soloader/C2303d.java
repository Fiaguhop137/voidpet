...
public class C2303d extends E implements w {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final Map f31353a = new HashMap();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final Map f31354b = new HashMap();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final Set f31355c;

    public C2303d(Context context) {
        this.f31355c = l(context);
    }
    ...
    private void f(String str, String str2, String str3) {
        synchronized (this.f31354b) {
            try {
                ...
                if (!this.f31354b.containsKey(str4)) {
                    this.f31354b.put(str4, new HashSet());
                }
                ((Set) this.f31354b.get(str4)).add(str3);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    private void g(String str, String str2) {
        synchronized (this.f31353a) {
            try {
                if (!this.f31353a.containsKey(str)) {
                    this.f31353a.put(str, new HashSet());
                }
                ((Set) this.f31353a.get(str)).add(str2);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    private Set k(String str, String str2) {
        Set set;
        synchronized (this.f31354b) {
            set = (Set) this.f31354b.get(str + str2);
        }
        return set;
    }
    ...
    public int d(String str, int i10, StrictMode.ThreadPolicy threadPolicy) throws IOException {
        ...
        for (String str2 : this.f31355c) {
            Set set = (Set) this.f31353a.get(str2);
            if (TextUtils.isEmpty(str2) || set == null || !set.contains(str)) {
                ...
                try {
                    i10 |= 4;
                    SoLoader.f31334b.a(str2 + File.separator + str, i10);
    ...
    public boolean o() {
        return !this.f31355c.isEmpty();
    }

    @Override // com.facebook.soloader.E
    public String toString() {
        return c() + "[root = " + this.f31355c.toString() + ']';
    }
}
