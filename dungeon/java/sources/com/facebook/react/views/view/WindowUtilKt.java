...
public final class WindowUtilKt {
    ...
    public static final /* synthetic */ int f31260a = 0;
    ...
    public static final void disableEdgeToEdge(@NotNull Window window) {
        ...
        AbstractC1921n0.b(window, true);
    }

    public static final void enableEdgeToEdge(@NotNull Window window) {
        Intrinsics.checkNotNullParameter(window, "<this>");
        int i10 = 0;
        AbstractC1921n0.b(window, false);
        Context context = window.getContext();
        Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
        boolean zA = p152i7.b.a(context);
        ...
        if (i11 < 29) {
            i10 = (i11 < 26 || zA) ? DarkNavigationBarColor : LightNavigationBarColor;
        }
        window.setNavigationBarColor(i10);
        new c1(window, window.getDecorView()).e(!zA);
        if (i11 >= 28) {
    ...
    public static final void setStatusBarTranslucency(@NotNull Window window, boolean z10) {
        Intrinsics.checkNotNullParameter(window, "<this>");
        if (z10) {
            window.getDecorView().setOnApplyWindowInsetsListener(new m());
        } else {
            window.getDecorView().setOnApplyWindowInsetsListener(null);
        }
        Z.j0(window.getDecorView());
    }
