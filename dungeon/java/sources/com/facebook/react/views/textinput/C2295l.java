...
public final class C2295l extends com.facebook.react.uimanager.events.d {
    ...
    public C2295l(int i10, int i11, String text, int i12) {
        super(i10, i11);
    ...
    protected WritableMap getEventData() {
        ...
        writableMapCreateMap.putString("text", this.f31240a);
        writableMapCreateMap.putInt("eventCount", this.f31241b);
