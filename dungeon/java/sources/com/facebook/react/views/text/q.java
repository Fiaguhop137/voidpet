...
public final class q {
    ...
    public static final q f31085a = new q();
    ...
    public static final Typeface a(Typeface typeface, int i10, int i11, String str, AssetManager assetManager) {
        ...
        u6.a.c cVar = new u6.a.c(i10, i11);
        if (str != null) {
            return p366u6.a.f55012c.c().g(str, cVar, assetManager);
        }
        if (typeface == null) {
    ...
    public static final int b(String str) {
        if (Intrinsics.b(str, "italic")) {
            return 2;
        }
        return Intrinsics.b(str, "normal") ? 0 : -1;
    }
    ...
    public static final int d(String str) {
        ...
        switch (str.hashCode()) {
            case -1039745817:
                return !str.equals("normal") ? -1 : 400;
            case 48625:
