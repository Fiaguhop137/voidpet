...
public class ReadableNativeMap extends NativeMap implements ReadableMap {
    ...
    /* JADX INFO: renamed from: com.facebook.react.bridge.ReadableNativeMap$keySetIterator$1, reason: invalid class name */
    ...
    protected ReadableNativeMap() {
        ...
        this.keys = Ad.j.a(mVar, new y(this));
        this.localMap = Ad.j.a(mVar, new z(this));
        this.localTypeMap = Ad.j.a(mVar, new A(this));
    }
    ...
    private final Object getValue(String name) {
        ...
        Object objC = p240n6.a.c(getLocalMap().get(name));
    ...
    public static final HashMap localMap_delegate$lambda$2(ReadableNativeMap readableNativeMap) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            map.put(readableNativeMap.getKeys()[i10], objArrImportValues[i10]);
        }
        return map;
    }
    ...
    public static final HashMap localTypeMap_delegate$lambda$3(ReadableNativeMap readableNativeMap) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            Object obj = objArrImportTypes[i10];
            Intrinsics.d(obj, "null cannot be cast to non-null type com.facebook.react.bridge.ReadableType");
    ...
    public ReadableMapKeySetIterator keySetIterator() {
        return new AnonymousClass1(getKeys());
    }
        ...
        for (String str : map.keySet()) {
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[getType(str2).ordinal()]) {
                ...
                case 4:
                    break;
                case 5:
                    map.put(str2, ((ReadableNativeMap) p240n6.a.c(getMap(str2))).toHashMap());
                    break;
                case 6:
                    map.put(str2, ((ReadableArray) p240n6.a.c(getArray(str2))).toArrayList());
                    break;
                default:
                    throw new Ad.n();
            }
