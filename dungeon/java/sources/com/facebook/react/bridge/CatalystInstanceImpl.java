...
public class CatalystInstanceImpl implements CatalystInstance {
    ...
    public static class Builder {
        ...
        public CatalystInstanceImpl build() {
            return new CatalystInstanceImpl((ReactQueueConfigurationSpec) p240n6.a.c(this.mReactQueueConfigurationSpec), (JavaScriptExecutor) p240n6.a.c(this.mJSExecutor), (NativeModuleRegistry) p240n6.a.c(this.mRegistry), (JSBundleLoader) p240n6.a.c(this.mJSBundleLoader), (JSExceptionHandler) p240n6.a.c(this.mJSExceptionHandler), this.mInspectorTarget, null);
        }
    ...
    private class NativeExceptionHandler implements QueueThreadExceptionHandler {
        ...
        /* synthetic */ NativeExceptionHandler(CatalystInstanceImpl catalystInstanceImpl, i iVar) {
            this();
        }
    ...
    static {
        ...
        p348t6.b.a("CatalystInstanceImpl", p348t6.a.WARNING);
    ...
    private CatalystInstanceImpl(ReactQueueConfigurationSpec reactQueueConfigurationSpec, JavaScriptExecutor javaScriptExecutor, NativeModuleRegistry nativeModuleRegistry, JSBundleLoader jSBundleLoader, JSExceptionHandler jSExceptionHandler, ReactInstanceManagerInspectorTarget reactInstanceManagerInspectorTarget) {
        ...
        W4.a.b("ReactNative", "Initializing React Xplat Bridge.");
        p295q7.a.c(0L, "createCatalystInstanceImpl");
        this.mHybridData = initHybrid();
        ReactQueueConfigurationImpl reactQueueConfigurationImplCreate = ReactQueueConfigurationImpl.create(reactQueueConfigurationSpec, new NativeExceptionHandler(this, null));
        ...
        this.mInspectorTarget = reactInstanceManagerInspectorTarget;
        p295q7.a.i(0L);
        W4.a.b("ReactNative", "Initializing React Xplat Bridge before initializeBridge");
        p295q7.a.c(0L, "initializeCxxBridge");
        ...
        W4.a.b("ReactNative", "Initializing React Xplat Bridge after initializeBridge");
        p295q7.a.i(0L);
        this.mJavaScriptContextHolder = new JavaScriptContextHolder(getJavaScriptContext());
    }

    /* synthetic */ CatalystInstanceImpl(ReactQueueConfigurationSpec reactQueueConfigurationSpec, JavaScriptExecutor javaScriptExecutor, NativeModuleRegistry nativeModuleRegistry, JSBundleLoader jSBundleLoader, JSExceptionHandler jSExceptionHandler, ReactInstanceManagerInspectorTarget reactInstanceManagerInspectorTarget, i iVar) {
    ...
    public void decrementPendingJSCalls() {
        ...
        p295q7.a.m(0L, this.mJsPendingCallsTitleForTrace, iDecrementAndGet);
    ...
    private TurboModuleRegistry getTurboModuleRegistry() {
        if (D6.e.e()) {
            return (TurboModuleRegistry) p240n6.a.d(this.mTurboModuleRegistry, "TurboModules are enabled, but mTurboModuleRegistry hasn't been set.");
        }
        return null;
    }
    ...
    public void incrementPendingJSCalls() {
        ...
        p295q7.a.m(0L, this.mJsPendingCallsTitleForTrace, andIncrement + 1);
        if (!z10 || this.mBridgeIdleListeners.isEmpty()) {
            return;
        }
    ...
    public /* synthetic */ void lambda$destroy$0() {
        ...
        W4.a.I("ReactNative", "CatalystInstanceImpl.destroy() end");
    ...
    public /* synthetic */ void lambda$destroy$2() {
        ...
        getReactQueueConfiguration().getJSQueueThread().runOnQueue(new RunnableC2197b(this));
    }
    ...
    public void callFunction(PendingJSCall pendingJSCall) {
        if (this.mDestroyed) {
            W4.a.I("ReactNative", "Calling JS function after bridge has been destroyed: " + pendingJSCall.toString());
            return;
        }
    ...
    public void lambda$onNativeException$6() {
        W4.a.b("ReactNative", "CatalystInstanceImpl.destroy() start");
        ...
        if (reactInstanceManagerInspectorTarget != null) {
            p240n6.a.b(reactInstanceManagerInspectorTarget.isValid(), "ReactInstanceManager inspector target destroyed before instance was unregistered");
        }
        unregisterFromInspector();
        ReactMarker.logMarker(ReactMarkerConstants.DESTROY_CATALYST_INSTANCE_START);
        this.mDestroyed = true;
        this.mNativeModulesQueueThread.runOnQueue(new RunnableC2196a(this));
        p295q7.a.p(this.mTraceListener);
    }
    ...
    public void initialize() {
        W4.a.b("ReactNative", "CatalystInstanceImpl.initialize()");
        p240n6.a.b(!this.mInitialized, "This catalyst instance has already been initialized");
        p240n6.a.b(this.mAcceptCalls, "RunJSBundle hasn't completed.");
    ...
    public void invokeCallback(int i10, NativeArrayInterface nativeArrayInterface) {
        if (this.mDestroyed) {
            W4.a.I("ReactNative", "Invoking JS callback after bridge has been destroyed.");
        } else {
    ...
    public void runJSBundle() {
        W4.a.b("ReactNative", "CatalystInstanceImpl.runJSBundle()");
        p240n6.a.b(!this.mJSBundleHasLoaded, "JS bundle was already loaded!");
        ...
        p295q7.a.k(this.mTraceListener);
    }
