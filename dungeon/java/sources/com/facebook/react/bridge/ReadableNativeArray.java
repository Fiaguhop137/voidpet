...
public class ReadableNativeArray extends NativeArray implements ReadableArray {
    ...
    protected ReadableNativeArray() {
        ...
        this.localArray = Ad.j.a(mVar, new w(this));
        this.localTypeArray = Ad.j.a(mVar, new x(this));
    }
    ...
    public boolean equals(@Nullable Object other) {
        if (other instanceof ReadableNativeArray) {
            return D6.b.u() ? nativeEquals((ReadableNativeArray) other) : AbstractC3952n.c(getLocalArray(), ((ReadableNativeArray) other).getLocalArray());
        }
        return false;
    }
