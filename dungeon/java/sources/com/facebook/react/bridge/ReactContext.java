...
public abstract class ReactContext extends ContextWrapper {
    ...
    /* JADX INFO: renamed from: com.facebook.react.bridge.ReactContext$1, reason: invalid class name */
    class AnonymousClass1 implements Runnable {
        ...
        public void run() {
            if (ReactContext.this.mLifecycleEventListeners.contains(this.val$listener)) {
                try {
    ...
    public void addLifecycleEventListener(LifecycleEventListener lifecycleEventListener) {
        ...
        runOnUiQueueThread(new AnonymousClass1(lifecycleEventListener));
    }
    ...
    public void assertOnJSQueueThread() {
        ((MessageQueueThread) p240n6.a.c(this.mJSMessageQueueThread)).assertIsOnThread();
    }
    ...
    public void assertOnNativeModulesQueueThread() {
        ...
        ((MessageQueueThread) p240n6.a.c(this.mNativeModulesMessageQueueThread)).assertIsOnThread();
    }
    ...
    public void assertOnNativeModulesQueueThread(String str) {
        ...
        ((MessageQueueThread) p240n6.a.c(this.mNativeModulesMessageQueueThread)).assertIsOnThread(str);
    }

    public void assertOnUiQueueThread() {
        ((MessageQueueThread) p240n6.a.c(this.mUiMessageQueueThread)).assertIsOnThread();
    }
    ...
    public synchronized void initializeMessageQueueThreads(ReactQueueConfiguration reactQueueConfiguration) {
        W4.a.b("ReactContext", "initializeMessageQueueThreads() is called.");
    ...
    public boolean isOnJSQueueThread() {
        return ((MessageQueueThread) p240n6.a.c(this.mJSMessageQueueThread)).isOnThread();
    }

    public boolean isOnNativeModulesQueueThread() {
        return ((MessageQueueThread) p240n6.a.c(this.mNativeModulesMessageQueueThread)).isOnThread();
    }

    public boolean isOnUiQueueThread() {
        return ((MessageQueueThread) p240n6.a.c(this.mUiMessageQueueThread)).isOnThread();
    }
    ...
    public boolean runOnJSQueueThread(Runnable runnable) {
        return ((MessageQueueThread) p240n6.a.c(this.mJSMessageQueueThread)).runOnQueue(runnable);
    }

    public void runOnNativeModulesQueueThread(Runnable runnable) {
        ((MessageQueueThread) p240n6.a.c(this.mNativeModulesMessageQueueThread)).runOnQueue(runnable);
    }

    public void runOnUiQueueThread(Runnable runnable) {
        ((MessageQueueThread) p240n6.a.c(this.mUiMessageQueueThread)).runOnQueue(runnable);
    }
