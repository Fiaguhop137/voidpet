...
abstract class e {
    ...
    /*  JADX ERROR: Types fix failed
        ...
        Caused by: java.lang.NullPointerException: Cannot invoke "jadx.core.dex.instructions.args.InsnArg.getType()" because "arg" is null
        	...
        	... 5 more
        */
    static com.google.android.material.carousel.f c(android.content.Context r19, float r20, float r21, com.google.android.material.carousel.a r22) {
        /*
            Method dump skipped, instruction units count: 293
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.carousel.e.c(android.content.Context, float, float, com.google.android.material.carousel.a):com.google.android.material.carousel.f");
    }
    ...
    static f e(Context context, float f10, float f11, a aVar) {
        float fMin = Math.min(f(context) + f10, aVar.f36376f);
        float f12 = fMin / 2.0f;
        float f13 = 0.0f - f12;
        float fB = b(0.0f, aVar.f36376f, aVar.f36377g);
        float fJ = j(0.0f, a(fB, aVar.f36376f, aVar.f36377g), aVar.f36376f, aVar.f36377g);
        float fB2 = b(fJ, aVar.f36375e, aVar.f36374d);
        float fB3 = b(j(fJ, fB2, aVar.f36375e, aVar.f36374d), aVar.f36372b, aVar.f36373c);
        float f14 = f12 + f11;
        float fB4 = d.b(fMin, aVar.f36376f, f10);
        float fB5 = d.b(aVar.f36372b, aVar.f36376f, f10);
        float fB6 = d.b(aVar.f36375e, aVar.f36376f, f10);
        f.b bVarH = new f.b(aVar.f36376f, f11).a(f13, fB4, fMin).h(fB, 0.0f, aVar.f36376f, aVar.f36377g, true);
        if (aVar.f36374d > 0) {
            bVarH.b(fB2, fB6, aVar.f36375e);
        }
        int i10 = aVar.f36373c;
        if (i10 > 0) {
            bVarH.g(fB3, fB5, aVar.f36372b, i10);
        }
    ...
    static float f(Context context) {
        return context.getResources().getDimension(Y8.c.f17081w);
    }

    static float g(Context context) {
        return context.getResources().getDimension(Y8.c.f17082x);
    }

    static float h(Context context) {
        return context.getResources().getDimension(Y8.c.f17083y);
    }
