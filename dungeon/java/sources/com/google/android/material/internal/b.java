...
public abstract class b {
    ...
    private static final ThreadLocal f36752a = new ThreadLocal();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f36753b = new ThreadLocal();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f36752a;
        ...
        ThreadLocal threadLocal2 = f36753b;
