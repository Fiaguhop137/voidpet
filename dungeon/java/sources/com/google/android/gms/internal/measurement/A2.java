...
public final class A2 extends AbstractC2461d5 implements F5 {
    private static final A2 zzn;
    private int zzb;
    private long zzg;
    private long zzk;
    private C2647y5 zzl = C2647y5.b();
    private C2647y5 zzm = C2647y5.b();
    private String zzd = "";
    private String zze = "";
    private String zzf = "";
    private String zzh = "";
    ...
    static {
        A2 a10 = new A2();
        zzn = a10;
        AbstractC2461d5.s(A2.class, a10);
    }

    private A2() {
    }

    public static C2628w2 c0() {
        return (C2628w2) zzn.o();
    }
    ...
    protected final Object B(int i10, Object obj, Object obj2) {
        ...
        if (i11 == 2) {
            return AbstractC2461d5.t(zzn, "\u0004\n\u0000\u0001\u0001\n\n\u0002\u0000\u0000\u0001ဈ\u0000\u0002ဈ\u0001\u0003ဈ\u0002\u0004ဂ\u0003\u0005ဈ\u0004\u0006ဈ\u0005\u0007ဈ\u0006\bဂ\u0007\t2\n2", new Object[]{"zzb", "zzd", "zze", "zzf", "zzg", "zzh", "zzi", "zzj", "zzk", "zzl", AbstractC2636x2.f33178a, "zzm", AbstractC2644y2.f33263a});
        }
        if (i11 == 3) {
            return new A2();
        }
        if (i11 == 4) {
            return new C2628w2(null);
        }
        if (i11 == 5) {
            return zzn;
        }
