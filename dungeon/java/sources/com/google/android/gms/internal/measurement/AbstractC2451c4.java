...
public abstract class AbstractC2451c4 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    static volatile B9.k f32882a = B9.k.a();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Object f32883b = new Object();
    ...
    public static boolean a(Context context, Uri uri) {
        ...
        if (f32882a.c()) {
            return ((Boolean) f32882a.b()).booleanValue();
        }
        synchronized (f32883b) {
            try {
                if (f32882a.c()) {
                    return ((Boolean) f32882a.b()).booleanValue();
                }
                ...
                f32882a = B9.k.d(Boolean.valueOf(z10));
                return ((Boolean) f32882a.b()).booleanValue();
            } catch (Throwable th) {
                throw th;
            }
