...
public enum EnumC2377i {
    ...
    EnumC2377i(String str) {
        this.f32400a = str;
    }

    public static final EnumC2377i e(String str) {
        for (EnumC2377i enumC2377i : values()) {
            if (enumC2377i.f32400a.equals(str)) {
                return enumC2377i;
            }
        }
        return UNKNOWN;
