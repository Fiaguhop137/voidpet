...
abstract class A0 {
    ...
    private static final b f37681a;

    private static class a {
        /* JADX INFO: Access modifiers changed from: private */
        public static void h(byte b10, byte b11, byte b12, byte b13, char[] cArr, int i10) throws B {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static void j(byte b10, byte b11, byte b12, char[] cArr, int i10) throws B {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static void k(byte b10, byte b11, char[] cArr, int i10) throws B {
            if (b10 < -62 || m(b11)) {
                throw B.d();
            }
    ...
    static abstract class b {
        ...
        private static int j(ByteBuffer byteBuffer, int i10, int i11) {
            int iL = i10 + A0.l(byteBuffer, i10, i11);
            while (iL < i11) {
                int i12 = iL + 1;
                ...
                if (b10 >= 0) {
                    ...
                    if (b10 >= -16) {
                        if (i12 >= i11 - 2) {
                            return A0.p(byteBuffer, b10, i12, i11 - i12);
                        }
                        int i13 = iL + 2;
        ...
        final String c(ByteBuffer byteBuffer, int i10, int i11) throws B {
    ...
    static final class c extends b {
        ...
        String b(byte[] bArr, int i10, int i11) throws B {
    ...
    static final class e extends b {
        ...
        private static int n(long j10, int i10) {
            ...
            while (true) {
                ...
                long j16 = 1 + j11;
                byte bW3 = z0.w(j11);
                if (bW3 <= -65 && ((bW != -32 || bW3 >= -96) && (bW != -19 || bW3 < -96))) {
                    j11 += 2;
                    if (z0.w(j16) > -65) {
                    }
                }
        ...
        private static int o(byte[] bArr, long j10, int i10) {
            int iQ = q(bArr, j10, i10);
            int i11 = i10 - iQ;
            long j11 = j10 + ((long) iQ);
            while (true) {
                byte bX = 0;
                while (i11 > 0) {
                    long j12 = j11 + 1;
                ...
                if (bX >= -16) {
                    if (i12 < 3) {
                        return s(bArr, bX, j11, i12);
                    }
                    i11 -= 4;
                    long j14 = 1 + j11;
                    byte bX2 = z0.x(bArr, j11);
                    if (bX2 <= -65 && (((bX << 28) + (bX2 + 112)) >> 30) == 0) {
                        long j15 = 2 + j11;
                        if (z0.x(bArr, j14) <= -65) {
                            j11 += 3;
                            if (z0.x(bArr, j15) > -65) {
                ...
                i11 -= 3;
                long j16 = 1 + j11;
                byte bX3 = z0.x(bArr, j11);
                if (bX3 <= -65 && ((bX != -32 || bX3 >= -96) && (bX != -19 || bX3 < -96))) {
                    j11 += 2;
                    if (z0.x(bArr, j16) > -65) {
                    }
                }
        ...
        private static int p(long j10, int i10) {
            ...
            int i13 = i10 - i11;
            while (i13 >= 8 && (z0.D(j10) & (-9187201950435737472L)) == 0) {
                j10 += 8;
                i13 -= 8;
            }
            return i10 - i13;
        ...
        private static int q(byte[] bArr, long j10, int i10) {
            ...
            while (true) {
                int i13 = i11 + 8;
                if (i13 > i10 || (z0.E(bArr, z0.f38133h + j10) & (-9187201950435737472L)) != 0) {
                    break;
                }
                j10 += 8;
                i11 = i13;
        ...
        private static int r(long j10, int i10, int i11) {
            ...
            if (i11 == 1) {
                return A0.n(i10, z0.w(j10));
            }
            if (i11 == 2) {
                return A0.o(i10, z0.w(j10), z0.w(j10 + 1));
            }
        ...
        private static int s(byte[] bArr, int i10, long j10, int i11) {
            ...
            if (i11 == 1) {
                return A0.n(i10, z0.x(bArr, j10));
            }
            if (i11 == 2) {
                return A0.o(i10, z0.x(bArr, j10), z0.x(bArr, j10 + 1));
            }
            throw new AssertionError();
        }
        ...
        @Override // com.google.protobuf.A0.b
        String d(ByteBuffer byteBuffer, int i10, int i11) throws B {
            if ((i10 | i11 | ((byteBuffer.limit() - i10) - i11)) < 0) {
                throw new ArrayIndexOutOfBoundsException(String.format("buffer limit=%d, index=%d, limit=%d", Integer.valueOf(byteBuffer.limit()), Integer.valueOf(i10), Integer.valueOf(i11)));
            }
            long jK = z0.k(byteBuffer) + ((long) i10);
            ...
            while (jK < j10) {
                ...
                if (a.n(bW2)) {
                    ...
                    long j13 = 2 + jK;
                    jK += 3;
                    a.j(bW2, z0.w(j11), z0.w(j13), cArr, i13);
                    i13++;
                } else {
                    if (j11 >= j10 - 2) {
                        throw B.d();
                    ...
                    byte bW5 = z0.w(2 + jK);
                    jK += 4;
                    a.h(bW2, bW4, bW5, z0.w(j14), cArr, i13);
                    i13 += 2;
                }
            }
                ...
                if (cCharAt2 < 128 && j13 < j14) {
                    ...
                    if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || j13 > j14 - 3) {
                        ...
                        if (i14 != length) {
                            ...
                            if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                z0.O(bArr, j13, (byte) ((codePoint >>> 18) | 240));
                                z0.O(bArr, j13 + j11, (byte) (((codePoint >>> 12) & 63) | 128));
                                long j15 = j13 + 3;
                                z0.O(bArr, j13 + 2, (byte) (((codePoint >>> 6) & 63) | 128));
                                j13 += 4;
                                z0.O(bArr, j15, (byte) ((codePoint & 63) | 128));
                                i13 = i14;
                            } else {
                                i13 = i14;
                            }
                    ...
                    z0.O(bArr, j13, (byte) ((cCharAt2 >>> '\f') | 480));
                    long j16 = j13 + 2;
                    j12 = j14;
                    z0.O(bArr, j13 + j11, (byte) (((cCharAt2 >>> 6) & 63) | 128));
                    j13 += 3;
                    z0.O(bArr, j16, (byte) ((cCharAt2 & '?') | 128));
                } else {
                    j11 = j10;
                    long j17 = j13 + j11;
                    z0.O(bArr, j13, (byte) ((cCharAt2 >>> 6) | 960));
                    j13 += 2;
                    z0.O(bArr, j17, (byte) ((cCharAt2 & '?') | 128));
                    j12 = j14;
                }
                i13++;
                j10 = j11;
        ...
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0058, code lost:
            ...
            if (com.google.protobuf.z0.x(r12, r0) > (-65)) goto L38;
         */
        /* JADX WARN: Code restructure failed: missing block: B:58:0x009e, code lost:
        
            if (com.google.protobuf.z0.x(r12, r0) > (-65)) goto L59;
         */
        @Override // com.google.protobuf.A0.b
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        int i(int r11, byte[] r12, int r13, int r14) {
            ...
            L10:
                ...
                if (r2 < r11) goto L29
                long r6 = r6 + r0
                byte r11 = com.google.protobuf.z0.x(r12, r0)
                if (r11 <= r5) goto L26
                goto L29
            L26:
                r0 = r6
            ...
            L2a:
                ...
                if (r0 < 0) goto L43
                int r11 = com.google.protobuf.A0.a(r2, r11)
                return r11
            L43:
                r0 = r8
            L44:
            ...
            L5e:
                ...
                if (r3 != 0) goto L76
                long r8 = r0 + r6
                byte r3 = com.google.protobuf.z0.x(r12, r0)
                int r11 = (r8 > r13 ? 1 : (r8 == r13 ? 0 : -1))
                if (r11 < 0) goto L73
                int r11 = com.google.protobuf.A0.a(r2, r3)
                return r11
            L73:
                r11 = 0
                r0 = r8
            ...
            L79:
                ...
                int r0 = (r8 > r13 ? 1 : (r8 == r13 ? 0 : -1))
                if (r0 < 0) goto L8a
                int r11 = com.google.protobuf.A0.b(r2, r3, r11)
                return r11
            L8a:
                r0 = r8
            L8b:
        ...
        /* JADX WARN: Code restructure failed: missing block: B:14:0x002d, code lost:
            ...
            if (com.google.protobuf.z0.w(r0) > (-65)) goto L17;
         */
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0061, code lost:
        
            if (com.google.protobuf.z0.w(r0) > (-65)) goto L36;
         */
        /* JADX WARN: Code restructure failed: missing block: B:56:0x00a3, code lost:
        
            if (com.google.protobuf.z0.w(r0) > (-65)) goto L57;
         */
        @Override // com.google.protobuf.A0.b
        /*
            Code decompiled incorrectly, please refer to instructions dump.
    ...
    static boolean r(ByteBuffer byteBuffer) {
        return f37681a.f(byteBuffer, byteBuffer.position(), byteBuffer.remaining());
    }

    static boolean s(byte[] bArr) {
        return f37681a.g(bArr, 0, bArr.length);
    }

    static boolean t(byte[] bArr, int i10, int i11) {
        return f37681a.g(bArr, i10, i11);
    }
}
