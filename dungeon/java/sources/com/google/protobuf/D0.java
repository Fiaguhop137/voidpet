...
interface D0 {
    ...
    void J(int i10, List list, n0 n0Var);

    void K(int i10, Object obj, n0 n0Var);

    void L(int i10, AbstractC3142h abstractC3142h);

    void M(int i10, List list, n0 n0Var);

    void N(int i10, Object obj, n0 n0Var);

    void O(int i10, L.a aVar, Map map);
