...
abstract class V {
    ...
    private static final char[] f37849a;
    ...
    private static boolean b(Object obj) {
        ...
        if (obj instanceof AbstractC3142h) {
            return obj.equals(AbstractC3142h.f37908b);
        }
        if (obj instanceof T) {
            return obj == ((T) obj).getDefaultInstanceForType();
        }
    ...
    static void d(StringBuilder sb2, int i10, String str, Object obj) {
        ...
        if (obj instanceof String) {
            sb2.append(": \"");
            sb2.append(t0.c((String) obj));
            sb2.append('\"');
            return;
        }
        if (obj instanceof AbstractC3142h) {
            sb2.append(": \"");
            sb2.append(t0.a((AbstractC3142h) obj));
            sb2.append('\"');
            return;
        }
    ...
    private static void e(T t10, StringBuilder sb2, int i10) {
        int i11;
        int i12;
        ...
        java.lang.reflect.Method[] declaredMethods = t10.getClass().getDeclaredMethods();
        ...
        for (Map.Entry entry : treeMap.entrySet()) {
            ...
            if (!strSubstring.endsWith("List") || strSubstring.endsWith("OrBuilderList") || strSubstring.equals("List") || (method4 = (java.lang.reflect.Method) entry.getValue()) == null) {
                ...
                if (method4.getReturnType().equals(List.class)) {
                    d(sb2, i10, strSubstring.substring(0, strSubstring.length() - 4), GeneratedMessageLite.invokeOrDie(method4, t10, new Object[0]));
                }
                i11 = i12;
            }
            if (!strSubstring.endsWith("Map") || strSubstring.equals("Map") || (method3 = (java.lang.reflect.Method) entry.getValue()) == null || !method3.getReturnType().equals(Map.class) || method3.isAnnotationPresent(Deprecated.class) || !Modifier.isPublic(method3.getModifiers())) {
                if (hashSet.contains("set" + strSubstring)) {
                    if (strSubstring.endsWith("Bytes")) {
                        if (!treeMap.containsKey("get" + strSubstring.substring(0, strSubstring.length() - 5))) {
                            ...
                            if (method != null) {
                                objInvokeOrDie = GeneratedMessageLite.invokeOrDie(method, t10, new Object[0]);
                                if (method2 == null) {
                                    zBooleanValue = ((Boolean) GeneratedMessageLite.invokeOrDie(method2, t10, new Object[0])).booleanValue();
                                } else if (b(objInvokeOrDie)) {
                                    zBooleanValue = false;
                                } else {
                                    zBooleanValue = true;
                                }
                                if (zBooleanValue) {
                                    d(sb2, i10, strSubstring, objInvokeOrDie);
                                }
                            }
                        }
                    } else {
                ...
                d(sb2, i10, strSubstring.substring(0, strSubstring.length() - 3), GeneratedMessageLite.invokeOrDie(method3, t10, new Object[0]));
            }
            i11 = i12;
        }
        if (t10 instanceof GeneratedMessageLite.ExtendableMessage) {
            Iterator itW = ((GeneratedMessageLite.ExtendableMessage) t10).extensions.w();
            while (itW.hasNext()) {
                Map.Entry entry2 = (Map.Entry) itW.next();
                d(sb2, i10, "[" + ((GeneratedMessageLite.d) entry2.getKey()).getNumber() + "]", entry2.getValue());
            }
        }
        w0 w0Var = ((GeneratedMessageLite) t10).unknownFields;
        if (w0Var != null) {
            w0Var.q(sb2, i10);
        }
    }

    static String f(T t10, String str) {
        StringBuilder sb2 = new StringBuilder();
        sb2.append("# ");
        sb2.append(str);
        e(t10, sb2, 0);
