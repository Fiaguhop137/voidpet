...
abstract class AbstractC3107b {
    ...
    private static final class a extends FilterInputStream {
        ...
        public int available() {
            return (int) Math.min(((FilterInputStream) this).in.available(), this.f37567a);
        }

        @Override // java.io.FilterInputStream, java.io.InputStream
        public synchronized void mark(int i10) {
            ((FilterInputStream) this).in.mark(i10);
            this.f37568b = this.f37567a;
        }
        ...
        public synchronized void reset() {
            ...
            this.f37567a = this.f37568b;
        }

        @Override // java.io.FilterInputStream, java.io.InputStream
        public long skip(long j10) throws IOException {
            long jSkip = ((FilterInputStream) this).in.skip(Math.min(j10, this.f37567a));
            this.f37567a -= jSkip;
            return jSkip;
        }
    }
