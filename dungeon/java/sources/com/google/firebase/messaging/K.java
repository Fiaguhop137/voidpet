...
public class K {
    ...
    private final Bundle f37493a;

    public K(Bundle bundle) {
        if (bundle == null) {
            throw new NullPointerException("data");
        }
        this.f37493a = new Bundle(bundle);
    }
    ...
    private String w(String str) {
        if (!this.f37493a.containsKey(str) && str.startsWith("gcm.n.")) {
            String strV = v(str);
            if (this.f37493a.containsKey(strV)) {
                return strV;
            }
        }
        return str;
    ...
    public String p(String str) {
        return this.f37493a.getString(w(str));
    }
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f37493a);
        for (String str : this.f37493a.keySet()) {
            if (!s(str)) {
                bundle.remove(str);
            }
        }
