...
public abstract class VirtualView extends com.facebook.react.views.view.g {
    ...
    float mOpacity;
    Path mPath;
    com.facebook.react.uimanager.I mPointerEvents;
    Region mRegion;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f38321a[SVGLength.UnitType.EXS.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f38321a[SVGLength.UnitType.CM.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f38321a[SVGLength.UnitType.MM.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f38321a[SVGLength.UnitType.IN.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f38321a[SVGLength.UnitType.PT.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f38321a[SVGLength.UnitType.PC.ordinal()] = 7;
    ...
    private double fromRelativeFast(SVGLength sVGLength) {
        ...
        switch (a.f38321a[sVGLength.f38275b.ordinal()]) {
            case 1:
        ...
        return sVGLength.f38274a * fontSizeFromContext * ((double) this.mScale);
    }
    ...
    private double getCanvasDiagonal() {
        ...
        double dSqrt = Math.sqrt(Math.pow(getCanvasWidth(), 2.0d) + Math.pow(getCanvasHeight(), 2.0d)) * 0.7071067811865476d;
    ...
    private float getCanvasHeight() {
        ...
        if (textRoot == null) {
            ...
            this.canvasHeight = textRoot.x().d();
        }
    ...
    Path getClipPath(Canvas canvas, Paint paint) {
        if (this.mClipPath != null) {
            C3166c c3166c = (C3166c) getSvgView().getDefinedClipPath(this.mClipPath);
            if (c3166c != null) {
                Path path = this.mClipRule == 0 ? c3166c.getPath(canvas, paint) : c3166c.y(canvas, paint, Region.Op.UNION);
                path.transform(c3166c.mMatrix);
                int i10 = this.mClipRule;
                if (i10 == 0) {
                    path.setFillType(Path.FillType.EVEN_ODD);
                } else if (i10 != 1) {
                    W4.a.I("ReactNative", "RNSVG: clipRule: " + this.mClipRule + " unrecognized");
                }
                this.mCachedClipPath = path;
            } else {
                W4.a.I("ReactNative", "RNSVG: Undefined clipPath: " + this.mClipPath);
            }
        }
        return getClipPath();
    }
    ...
    public SvgView getSvgView() {
        ...
        if (parent instanceof SvgView) {
            ...
            W4.a.m("ReactNative", "RNSVG: " + getClass().getName() + " should be descendant of a SvgView.");
        }
        return this.svgView;
    }
    ...
    protected void onMeasure(int i10, int i11) {
        RectF rectF = this.mClientRect;
        int iCeil = rectF != null ? (int) Math.ceil(rectF.width()) : View.getDefaultSize(getSuggestedMinimumWidth(), i10);
        RectF rectF2 = this.mClientRect;
        setMeasuredDimension(iCeil, rectF2 != null ? (int) Math.ceil(rectF2.height()) : View.getDefaultSize(getSuggestedMinimumHeight(), i11));
    }

    double relativeOn(SVGLength sVGLength, float f10) {
        SVGLength.UnitType unitType = sVGLength.f38275b;
        if (unitType == SVGLength.UnitType.NUMBER) {
            return sVGLength.f38274a * ((double) this.mScale);
        }
        return unitType == SVGLength.UnitType.PERCENTAGE ? (sVGLength.f38274a / 100.0d) * ((double) f10) : fromRelativeFast(sVGLength);
    }
    ...
    void setClientRect(RectF rectF) {
        ...
        if (rectF2 == null || !rectF2.equals(rectF)) {
            ...
            EventDispatcher eventDispatcherC = C2270o0.c(this.mContext, getId());
            if (eventDispatcherC != null) {
                eventDispatcherC.d(com.facebook.react.uimanager.G.d(getId(), iFloor, iFloor2, iCeil, iCeil2));
            }
        }
    }
    ...
    public void setPointerEvents(com.facebook.react.uimanager.I i10) {
        this.mPointerEvents = i10;
    }
