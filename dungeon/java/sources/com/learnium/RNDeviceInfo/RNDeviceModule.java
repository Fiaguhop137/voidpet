...
public class RNDeviceModule extends ReactContextBaseJavaModule {
    ...
    private final Ca.a deviceIdResolver;
    private final Ca.b deviceTypeResolver;
    ...
    private i installReferrerClient;
    ...
    class a extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (!RNDeviceModule.this.mLastBatteryState.equalsIgnoreCase(string) || RNDeviceModule.this.mLastPowerSaveState != z10) {
                ...
                writableMapCreateMap.putDouble(RNDeviceModule.BATTERY_LEVEL, d10);
                writableMapCreateMap.putBoolean(RNDeviceModule.LOW_POWER_MODE, z10);
    ...
    public RNDeviceModule(ReactApplicationContext reactApplicationContext) {
        ...
        this.deviceTypeResolver = new Ca.b(reactApplicationContext);
        this.deviceIdResolver = new Ca.a(reactApplicationContext);
        this.installReferrerClient = new i(reactApplicationContext.getBaseContext());
        this.inputMethodManager = (InputMethodManager) reactApplicationContext.getSystemService("input_method");
    }

    public static /* synthetic */ Object a(Promise promise, Object obj, Method method, Object[] objArr) {
    ...
    public static /* synthetic */ Object b(Promise promise, Object obj, Method method, Object[] objArr) throws IllegalAccessException, InvocationTargetException {
        if ("onSuccess".equals(method.getName()) && objArr != null && objArr.length == 1) {
            ...
            Object objInvoke = obj2.getClass().getMethod("getScope", null).invoke(obj2, null);
            ...
            writableMapCreateMap.putInt("scope", iIntValue);
            promise.resolve(writableMapCreateMap);
        }
        return null;
    }
    ...
    public WritableMap getPowerStateFromIntent(Intent intent) {
        ...
        writableMapCreateMap.putDouble(BATTERY_LEVEL, f10);
    ...
    public void getAppSetId(Promise promise) {
        try {
            ...
            Object objInvoke = AppSet.class.getMethod("getClient", Context.class).invoke(null, getReactApplicationContext());
            ...
            Object objNewProxyInstance = Proxy.newProxyInstance(classLoader, new Class[]{cls}, new e(promise));
            Class<?> cls2 = Class.forName("com.google.android.gms.tasks.OnFailureListener", true, classLoader);
            Object objNewProxyInstance2 = Proxy.newProxyInstance(classLoader, new Class[]{cls2}, new f(promise));
            objInvoke2.getClass().getMethod("addOnSuccessListener", cls).invoke(objInvoke2, objNewProxyInstance);
            objInvoke2.getClass().getMethod("addOnFailureListener", cls2).invoke(objInvoke2, objNewProxyInstance2);
        } catch (Throwable th) {
    ...
    public Map<String, Object> getConstants() {
        ...
        map.put("deviceType", this.deviceTypeResolver.a().g());
        return map;
    }
    ...
    public String getDeviceNameSync() {
        ...
        try {
            ...
            if (i10 > 31 || (string2 = Settings.Secure.getString(getReactApplicationContext().getContentResolver(), "bluetooth_name")) == null) {
                return (i10 < 25 || (string = Settings.Global.getString(getReactApplicationContext().getContentResolver(), "device_name")) == null) ? "unknown" : string;
            }
            return string2;
        } catch (Exception unused) {
            return "unknown";
    ...
    public boolean hasGmsSync() {
        try {
            int i10 = C2341j.f31906d;
            Object objInvoke = C2341j.class.getMethod("getInstance", null).invoke(null, null);
    ...
    public boolean hasHmsSync() {
        try {
            Object objInvoke = Class.forName("com.huawei.hms.api.HuaweiApiAvailability").getMethod("getInstance", null).invoke(null, null);
