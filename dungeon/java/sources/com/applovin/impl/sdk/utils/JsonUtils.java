...
public abstract class JsonUtils {
    ...
    public static JSONArray deepCopy(JSONArray jSONArray) {
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            try {
                ...
                p1.a("Failed to copy over item at index " + i10 + " to JSONArray deep copy");
            }
        }
        return jSONArray2;
    }
    ...
    public static JSONObject deepCopy(JSONObject jSONObject) {
        ...
        while (itKeys.hasNext()) {
            ...
            try {
                ...
                p1.a("Failed to copy over item for key '" + next + "' to JSONObject deep copy");
            }
        }
        return jSONObject2;
    }
    ...
    public static JSONObject deserialize(String str) {
        ...
        try {
            ...
            p1.b("JsonUtils", "Failed to deserialize into JSON: " + str, th);
            return null;
        }
    }
    ...
    public static double getDouble(JSONObject jSONObject, String str, double d10) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                p1.b("JsonUtils", "Failed to retrieve double property for key = " + str, e10);
            }
        }
        return d10;
    }
    ...
    public static float getFloat(JSONObject jSONObject, String str, float f10) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                p1.b("JsonUtils", "Failed to retrieve float property for key = " + str, e10);
            }
        }
        return f10;
    }
    ...
    public static int getInt(JSONObject jSONObject, String str, int i10) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                p1.b("JsonUtils", "Failed to retrieve int property for key = " + str, e10);
            }
        }
        return i10;
    }
    ...
    public static JSONArray getJSONArray(JSONObject jSONObject, String str, JSONArray jSONArray) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                p1.b("JsonUtils", "Failed to retrieve JSON array for key = " + str, e10);
            }
        }
        return jSONArray;
    }
    ...
    public static JSONObject getJSONObject(JSONArray jSONArray, int i10, JSONObject jSONObject) {
        if (jSONArray != null && i10 < jSONArray.length()) {
            try {
                ...
                p1.b("JsonUtils", "Failed to retrieve JSON object from array for index = " + i10, e10);
            }
        }
        return jSONObject;
    }
    ...
    public static JSONObject getJSONObject(JSONObject jSONObject, String str, JSONObject jSONObject2) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                p1.b("JsonUtils", "Failed to retrieve JSON property for key = " + str, e10);
            }
        }
        return jSONObject2;
    }
    ...
    public static long getLong(JSONObject jSONObject, String str, long j10) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                p1.b("JsonUtils", "Failed to retrieve long property for key = " + str, e10);
            }
        }
        return j10;
    }
    ...
    public static Object getObject(JSONObject jSONObject, String str, Object obj) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                p1.b("JsonUtils", "Failed to retrieve Object for key = " + str, e10);
            }
        }
        return obj;
    }
    ...
    public static Object getObjectAtIndex(JSONArray jSONArray, int i10, Object obj) {
        if (jSONArray != null && jSONArray.length() > i10) {
            try {
                ...
                p1.b("JsonUtils", "Failed to retrieve object at index " + i10 + " for JSON array", e10);
            }
        }
        return obj;
    }
    ...
    public static String getString(JSONObject jSONObject, String str, String str2) {
        if (jSONObject != null) {
            try {
                ...
                p1.b("JsonUtils", "Failed to retrieve string property for key = " + str, e10);
            }
        }
        return str2;
    }
    ...
    public static JSONObject jsonObjectFromJsonString(String str, JSONObject jSONObject) {
        try {
            ...
            p1.b("JsonUtils", "Failed to convert JSON string '" + str + "' to JSONObject", e10);
            return jSONObject;
        }
    }
    ...
    public static void putBoolean(JSONObject jSONObject, String str, boolean z10) {
        if (jSONObject != null) {
            try {
                ...
                p1.b("JsonUtils", "Failed to put boolean property for key = " + str, e10);
            }
        }
    }
    ...
    public static void putDouble(JSONObject jSONObject, String str, double d10) {
        if (jSONObject != null) {
            try {
                ...
                p1.b("JsonUtils", "Failed to put double property for key = " + str, e10);
            }
        }
    }
    ...
    public static void putInt(JSONObject jSONObject, String str, int i10) {
        if (jSONObject != null) {
            try {
                ...
                p1.b("JsonUtils", "Failed to put int property for key = " + str, e10);
            }
        }
    }
    ...
    public static void putJSONObject(JSONObject jSONObject, String str, JSONObject jSONObject2) {
        if (jSONObject != null) {
            try {
                ...
                p1.b("JsonUtils", "Failed to put JSON property for key = " + str, e10);
            }
        }
    }
    ...
    public static void putJsonArray(JSONObject jSONObject, String str, JSONArray jSONArray) {
        if (jSONObject != null) {
            try {
                ...
                p1.b("JsonUtils", "Failed to put JSONArray property for key = " + str, e10);
            }
        }
    }
    ...
    public static void putLong(JSONObject jSONObject, String str, long j10) {
        if (jSONObject != null) {
            try {
                ...
                p1.b("JsonUtils", "Failed to put long property for key = " + str, e10);
            }
        }
    }
    ...
    public static void putObject(JSONObject jSONObject, String str, Object obj) {
        if (jSONObject != null) {
            try {
                ...
                p1.b("JsonUtils", "Failed to put Object property for key = " + str, e10);
            }
        }
    }
    ...
    public static void putString(JSONObject jSONObject, String str, String str2) {
        if (jSONObject != null) {
            try {
                ...
                p1.b("JsonUtils", "Failed to put String property for key = " + str, e10);
            }
        }
    }
    ...
    public static JSONObject shallowCopy(JSONObject jSONObject) {
        ...
        while (itKeys.hasNext()) {
            ...
            try {
                ...
                p1.a("Failed to copy over item for key '" + next + "' to JSONObject copy");
            }
        }
        return jSONObject2;
    }
    ...
    public static <T> List<T> toList(JSONArray jSONArray) throws JSONException {
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            arrayList2.add(a(jSONArray.get(i10)));
        }
        return arrayList2;
    }
    ...
    public static Map<String, String> toStringMap(JSONObject jSONObject) throws JSONException {
        ...
        while (itKeys.hasNext()) {
            String next = itKeys.next();
            map.put(next, String.valueOf(a(jSONObject.get(next))));
        }
        return map;
    }
    ...
    public static Map<String, Object> toStringObjectMap(String str) {
        try {
            ...
            p1.b("JsonUtils", "Failed to convert json string '" + str + "' to map", e10);
            return new HashMap();
        }
    }
