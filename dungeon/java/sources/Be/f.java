...
public final class f {
    ...
    private final OutputStream f734e;
    ...
    private void J() throws IOException {
        OutputStream outputStream = this.f734e;
        if (outputStream == null) {
            throw new a();
        }
        outputStream.write(this.f730a, 0, this.f732c);
        this.f732c = 0;
    }
    ...
    public void i0(d dVar, int i10, int i11) throws IOException {
        ...
        int i13 = this.f732c;
        if (i12 - i13 >= i11) {
            dVar.j(this.f730a, i10, i13, i11);
            this.f732c += i11;
            this.f733d += i11;
            return;
        }
        int i14 = i12 - i13;
        dVar.j(this.f730a, i10, i13, i14);
        int i15 = i10 + i14;
        int i16 = i11 - i14;
        this.f732c = this.f731b;
        this.f733d += i14;
        J();
        if (i16 <= this.f731b) {
            dVar.j(this.f730a, i15, 0, i16);
            this.f732c = i16;
        } else {
            dVar.y(this.f734e, i15, i16);
        }
        this.f733d += i16;
    }
    ...
    public void k0(byte[] bArr, int i10, int i11) throws IOException {
        ...
        int i13 = this.f732c;
        if (i12 - i13 >= i11) {
            System.arraycopy(bArr, i10, this.f730a, i13, i11);
            this.f732c += i11;
            this.f733d += i11;
            return;
        }
        int i14 = i12 - i13;
        System.arraycopy(bArr, i10, this.f730a, i13, i14);
        int i15 = i10 + i14;
        int i16 = i11 - i14;
        this.f732c = this.f731b;
        this.f733d += i14;
        J();
        if (i16 <= this.f731b) {
            System.arraycopy(bArr, i15, this.f730a, 0, i16);
            this.f732c = i16;
        } else {
            this.f734e.write(bArr, i15, i16);
        }
        this.f733d += i16;
    }
