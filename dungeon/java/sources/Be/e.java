...
public final class e {
    ...
    private final InputStream f722f;
    ...
    private int f726j = Integer.MAX_VALUE;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    private int f728l = 64;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    private int f729m = 67108864;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final byte[] f717a = new byte[4096];
    ...
    private final boolean f718b = false;

    private e(InputStream inputStream) {
        this.f722f = inputStream;
    }
    ...
    private void M() {
        int i10 = this.f719c + this.f720d;
        this.f719c = i10;
        int i11 = this.f725i + i10;
        int i12 = this.f726j;
        if (i11 <= i12) {
            this.f720d = 0;
            return;
    ...
    private boolean S(int i10) throws IOException {
        ...
        if (this.f725i + i11 + i10 <= this.f726j && this.f722f != null) {
            if (i11 > 0) {
                if (i13 > i11) {
            ...
            if (i15 > 0) {
                this.f719c += i15;
                if ((this.f725i + i10) - this.f729m > 0) {
                    throw k.j();
                }
                M();
                if (this.f719c >= i10) {
    ...
    private byte[] w(int i10) throws k {
        ...
        if (i10 < 4096) {
            ...
            int i15 = this.f719c - i12;
            System.arraycopy(this.f717a, i12, bArr, 0, i15);
            this.f721e = this.f719c;
            int i16 = i10 - i15;
            d(i16);
            System.arraycopy(this.f717a, 0, bArr, i15, i16);
            this.f721e = i16;
            return bArr;
        }
        int i17 = this.f719c;
        ...
        System.arraycopy(this.f717a, i12, bArr3, 0, length);
    ...
    public String H() {
        ...
        String str = new String(this.f717a, i11, iZ, "UTF-8");
        this.f721e += iZ;
        return str;
    }
    ...
    public int e() {
        ...
        return i10 - (this.f725i + this.f721e);
    }

    public boolean f() {
        return this.f721e == this.f719c && !S(1);
    }
    ...
    public int i(int i10) throws k {
        ...
        int i11 = i10 + this.f725i + this.f721e;
        int i12 = this.f726j;
        if (i11 > i12) {
            throw k.k();
        }
    ...
    public d k() {
        ...
        int i11 = this.f721e;
        if (iZ > i10 - i11 || iZ <= 0) {
            return iZ == 0 ? d.f710a : new o(w(iZ));
        }
        d cVar = (this.f718b && this.f724h) ? new c(this.f717a, this.f721e, iZ) : d.h(this.f717a, i11, iZ);
        this.f721e += iZ;
        return cVar;
    }
