...
public final class d {
    ...
    private final Shader f19071a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final ColorStateList f19072b;
    ...
    public boolean h() {
        return this.f19071a != null;
    }

    public boolean i() {
        ColorStateList colorStateList;
        return this.f19071a == null && (colorStateList = this.f19072b) != null && colorStateList.isStateful();
    }
    ...
    public boolean j(int[] iArr) {
        ...
        ColorStateList colorStateList = this.f19072b;
        int colorForState = colorStateList.getColorForState(iArr, colorStateList.getDefaultColor());
        if (colorForState == this.f19073c) {
            return false;
        }
        this.f19073c = colorForState;
        return true;
    }
