...
public final /* data */ class DirectoryInfo implements c {
    ...
    public DirectoryInfo(boolean z10, @Nullable String str, @Nullable List<String> list, @Nullable String str2, @Nullable Long l10, @Nullable Long l11, @Nullable Long l12) {
        this.exists = z10;
        this.uri = str;
        this.files = list;
        this.md5 = str2;
    ...
    @NotNull
    public final DirectoryInfo copy(boolean exists, @Nullable String uri, @Nullable List<String> files, @Nullable String md5, @Nullable Long size, @Nullable Long modificationTime, @Nullable Long creationTime) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return this.exists == directoryInfo.exists && Intrinsics.b(this.uri, directoryInfo.uri) && Intrinsics.b(this.files, directoryInfo.files) && Intrinsics.b(this.md5, directoryInfo.md5) && Intrinsics.b(this.size, directoryInfo.size) && Intrinsics.b(this.modificationTime, directoryInfo.modificationTime) && Intrinsics.b(this.creationTime, directoryInfo.creationTime);
    }
