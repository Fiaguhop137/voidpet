...
public abstract class AbstractC3732l {
    ...
    public static Date d() {
        return Calendar.getInstance(io.sentry.vendor.gson.internal.bind.util.a.f46648a).getTime();
    }

    public static Date e(long j10) {
        Calendar calendar = Calendar.getInstance(io.sentry.vendor.gson.internal.bind.util.a.f46648a);
    ...
    public static Date o(AbstractC3750o2 abstractC3750o2) {
        if (abstractC3750o2 == null) {
            return null;
        }
        return p(abstractC3750o2);
    }

    public static Date p(AbstractC3750o2 abstractC3750o2) {
        return k(abstractC3750o2.p());
    }
}
