...
public final class SentryNdk {
    ...
    static {
        new Thread(new j(), "SentryNdkLoadLibs").start();
    }
    ...
    public static void init(@NotNull SentryAndroidOptions sentryAndroidOptions) {
        ...
        try {
            ...
            if (ndkHandlerStrategy == Q0.SENTRY_HANDLER_STRATEGY_DEFAULT.getValue()) {
                ndkOptions.setNdkHandlerStrategy(io.sentry.ndk.b.SENTRY_HANDLER_STRATEGY_DEFAULT);
            } else if (ndkHandlerStrategy == Q0.SENTRY_HANDLER_STRATEGY_CHAIN_AT_START.getValue()) {
