...
public abstract class P {
    public static int a(int i10, int i11, String str) {
        ...
        if (i10 < 0) {
            strA = Q.a("%s (%s) must not be negative", "index", Integer.valueOf(i10));
        } else {
            if (i11 < 0) {
                throw new IllegalArgumentException("negative size: " + i11);
            }
            strA = Q.a("%s (%s) must be less than size (%s)", "index", Integer.valueOf(i10), Integer.valueOf(i11));
        }
    ...
    public static void c(int i10, int i11, int i12) {
        ...
        if (i10 < 0 || i11 < i10 || i11 > i12) {
            if (i10 < 0 || i10 > i12) {
                ...
                strD = (i11 < 0 || i11 > i12) ? d(i11, i12, "end index") : Q.a("end index (%s) must not be less than start index (%s)", Integer.valueOf(i11), Integer.valueOf(i10));
            }
