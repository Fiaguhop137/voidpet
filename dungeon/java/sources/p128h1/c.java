        ...
        for (Pair pair : pairArr) {
            ...
            if (second == null) {
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    Intrinsics.d(second, "null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                    bundle.putParcelableArray(str, (Parcelable[]) second);
                } else if (String.class.isAssignableFrom(componentType)) {
                    Intrinsics.d(second, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                    bundle.putStringArray(str, (String[]) second);
                } else if (CharSequence.class.isAssignableFrom(componentType)) {
                    Intrinsics.d(second, "null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");
