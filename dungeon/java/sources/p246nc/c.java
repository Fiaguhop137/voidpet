...
public final class c {
    ...
    private final Function1 f49951a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final WeakReference f49952b;

    public c(View view, Function1 function1) {
        Intrinsics.checkNotNullParameter(view, "view");
        this.f49951a = function1;
        this.f49952b = new WeakReference(view);
    }

    public final b a(View thisRef, k property) {
        Intrinsics.checkNotNullParameter(thisRef, "thisRef");
        Intrinsics.checkNotNullParameter(property, "property");
        View view = (View) this.f49952b.get();
        if (view != null) {
            return new a(property.getName(), view, this.f49951a);
        }
