...
public abstract class e {
    ...
    class a extends InputConnectionWrapper {
        ...
        public boolean commitContent(InputContentInfo inputContentInfo, int i10, Bundle bundle) {
            if (this.f50312a.a(f.f(inputContentInfo), i10, bundle)) {
                return true;
            }
    ...
    class b extends InputConnectionWrapper {
        ...
        public boolean performPrivateCommand(String str, Bundle bundle) {
            if (e.e(str, bundle, this.f50313a)) {
                return true;
            }
    ...
    public static /* synthetic */ boolean a(View view, f fVar, int i10, Bundle bundle) {
        ...
        return Z.c0(view, new C1900d.a(new ClipData(fVar.b(), new ClipData.Item(fVar.a())), 2).d(fVar.c()).b(bundle).a()) == null;
    }
    ...
    public static InputConnection d(InputConnection inputConnection, EditorInfo editorInfo, c cVar) {
        p199l1.c.d(inputConnection, "inputConnection must be non-null");
        p199l1.c.d(editorInfo, "editorInfo must be non-null");
        p199l1.c.d(cVar, "onCommitContentListener must be non-null");
        if (Build.VERSION.SDK_INT >= 25) {
            return new a(inputConnection, false, cVar);
        }
        return p253o1.c.a(editorInfo).length == 0 ? inputConnection : new b(inputConnection, false, cVar);
    }
