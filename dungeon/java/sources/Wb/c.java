...
public class c implements Nb.b, p227mb.d {
    ...
    protected EnumSet b(String path) {
        ...
        EnumSet enumSetNoneOf = EnumSet.noneOf(Nb.c.class);
        if (file.canRead()) {
            enumSetNoneOf.add(Nb.c.READ);
        }
        if (file.canWrite()) {
            enumSetNoneOf.add(Nb.c.WRITE);
        }
    ...
    @Override // p227mb.d
    public List h() {
        return CollectionsKt.e(Nb.b.class);
    }
}
